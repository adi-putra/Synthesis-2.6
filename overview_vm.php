                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                foreach ($result as $row) {
                                                  ...
                                                  print "<option value='overview_vm.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="vm-problems" checked><a href="#vm-problems">Problems</a></li>
                    <!-- <li><input type="checkbox" class="sub-box" value="vm-about" checked><a href="#vm-about">About</a></li> -->
                    <li><input type="checkbox" class="sub-box" value="vm-uptime" checked><a href="#vm-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-cpuusage" checked><a href="#vm-cpuusage">CPU Usage</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-memusage" checked><a href="#vm-memusage">Memory Usage</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-freedisk" checked><a href="#vm-freedisk">Free Disk Space</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-cpuusagegraph" checked><a href="#vm-cpuusagegraph">CPU Usage Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-memusagegraph" checked><a href="#vm-memusagegraph">Memory Usage Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-readlatencygraph" checked><a href="#vm-readlatencygraph">Average Read Latency Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-writelatencygraph" checked><a href="#vm-writelatencygraph">Average Write Latency Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-networkutilgraph" checked><a href="#vm-networkutilgraph">Network Utilization Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-bytesrecgraph" checked><a href="#vm-bytesrecgraph">Bytes Received Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vm-bytestransmitgraph" checked><a href="#vm-bytestransmitgraph">Bytes Transmitted Graph</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
              ...
              <div class="box-body">
                      ...
                      <div class="box-body">
                        ...
                        <script>
                          ...
                          function loadAbout() {      
                            ...
                            getabout_xhr = $.ajax({
                              url: "ajax/vm/getabout.php?groupid=" + groupid + hostArr + timerange, 
                              success: function(result) {
                      ...
                      <div class="box-body">
                        <div id="getuptime"></div>        
                          <script>
                            ...
                            function loadUptime() {      
                              //console.log("load");           
                              // $("#getuptime").load("ajax/vm/getuptime.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              getuptime_xhr = $.ajax({
                                url: "ajax/vm/getuptime.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                        ...
                        <div id="cpu_usage"></div>        
                          <script>
                            ...
                            function loadCPUUsage() {      
                              //console.log("load");           
                              // $("#cpu_usage").load("ajax/vm/cpu_usage.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              cpu_usage_xhr = $.ajax({
                                url: "ajax/vm/cpu_usage.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                        ...
                        <div id="mem_usage"></div>        
                          <script>
                            ...
                            function loadMemUsage() {      
                              //console.log("load");           
                              // $("#mem_usage").load("ajax/vm/mem_usage.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              mem_usage_xhr = $.ajax({
                                url: "ajax/vm/mem_usage.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                      ...
                      <div class="box-body">
                        ...
                        <script>
                          ...
                          function loadFreeDiskSpace() { 
                            // $("#getdisk").load("ajax/vm/getdisk.php?groupid=" + groupid + "&" + hostArr + timerange);
                            getdisk_xhr = $.ajax({
                              url: "ajax/vm/getdisk.php?groupid=" + groupid + hostArr + timerange, 
                              success: function(result) {
                                $("#getdisk").html(result);
                              },
                              complete: function() {
                ...
                <div class="row" id="vm-cpuusagegraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="getcpugraph"></div>        
                          <script>
                            ...
                            function loadCPUUsageGraph() {      
                              //console.log("load");           
                              // $("#getcpugraph").load("ajax/vm/getcpugraph.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              getcpugraph_xhr = $.ajax({
                                url: "ajax/vm/getcpugraph.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vm-memusagegraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="getmemgraph"></div>        
                          <script>
                            ...
                            function loadMemUsageGraph() {      
                              //console.log("load");           
                              // $("#getmemgraph").load("ajax/vm/getmemgraph.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              getmemgraph_xhr = $.ajax({
                                url: "ajax/vm/getmemgraph.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vm-readlatencygraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="read_latency"></div>        
                          <script>
                            ...
                            function loadReadLatency() {      
                              //console.log("load");           
                              // $("#read_latency").load("ajax/vm/read_latency.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              read_latency_xhr = $.ajax({
                                url: "ajax/vm/read_latency.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vm-writelatencygraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="write_latency"></div>        
                          <script>
                            ...
                            function loadWriteLatency() {      
                              //console.log("load");           
                              // $("#write_latency").load("ajax/vm/write_latency.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              write_latency_xhr = $.ajax({
                                url: "ajax/vm/write_latency.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vm-networkutilgraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="network_util"></div>        
                          <script>
                            ...
                            function loadNetworkUtil() {      
                              //console.log("load");           
                              // $("#network_util").load("ajax/vm/network_util.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              network_util_xhr = $.ajax({
                                url: "ajax/vm/network_util.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vm-bytesrecgraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="bytes_received"></div>        
                          <script>
                            ...
                            function loadBytesRec() {      
                              //console.log("load");           
                              // $("#bytes_received").load("ajax/vm/bytes_received.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              bytes_received_xhr = $.ajax({
                                url: "ajax/vm/bytes_received.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vm-bytestransmitgraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="bytes_transmit"></div>        
                          <script>
                            ...
                            function loadBytesTransmit() {      
                              // console.log("load");           
                              // $("#bytes_transmit").load("ajax/vm/bytes_transmit.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              bytes_transmit_xhr = $.ajax({
                                url: "ajax/vm/bytes_transmit.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <!-- <div class="row" id="vm-packetsrecgraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                      ...
                      <div class="box-body">
                        <div id="packets_received"></div>        
                          <script>
                            ...
                            //   //console.log("load");           
                            //   $("#packets_received").load("ajax/vm/packets_received.php?groupid=" + groupid + "&" + hostArr + timerange);     
                            // }
                          </script>
                      </div>
                    </div>
                ...
                <div class="row" id="vm-packetstransmitgraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                      ...
                      <div class="box-body">
                        <div id="packets_transmit"></div>        
                          <script>
                            ...
                            //   //console.log("load");           
                            //   $("#packets_transmit").load("ajax/vm/packets_transmit.php?groupid=" + groupid + "&" + hostArr + timerange);     
                            // }
                          </script>
                      </div>
                    </div>
