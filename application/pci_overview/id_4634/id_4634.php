...
foreach ($hostid as $hostID) {
    ...
    foreach ($result as $host) {
        ...
        "hostids" => $hostID,
        "search" => array("name" => "Event ID 4634 : An account was logged off"), //seach id contains specific word
        );
        //call api method
...
<!-- HTML -->
<div id="chart4634_div" style="<?php echo $chart_style;?>"></div>
...
var chart_4634 = am4core.create("chart4634_div", am4charts.XYChart);
chart_4634.hiddenState.properties.opacity = 0; // this creates initial fade-in
//chart_4634.fontSize = 10;

/*var title = chart_4634.titles.create();
title.text = '<?php echo $chart_title; ?>';
title.fontSize = 25;
title.marginBottom = 30;
title.align = 'center';*/

chart_4634.paddingRight = 30;
chart_4634.dateFormatter.inputDateFormat = "dd-MM-yyyy HH:mm:ss a";

chart_4634.dateFormatter.dateFormat = "dd-MM-yyyy HH:mm:ss a";
chart_4634.dateFormatter.inputDateFormat = "dd-MM-yyyy HH:mm:ss a";

var categoryAxis = chart_4634.yAxes.push(new am4charts.CategoryAxis());
categoryAxis.dataFields.category = "category";
categoryAxis.renderer.grid.template.location = 0;
categoryAxis.renderer.inversed = true;

var dateAxis = chart_4634.xAxes.push(new am4charts.DateAxis());
...
chart_4634.data = <?php print $itemseries; ?>

var series1 = chart_4634.series.push(new am4charts.ColumnSeries());
...
chart_4634.scrollbarX = new am4core.Scrollbar();
