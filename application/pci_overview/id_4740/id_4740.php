...
foreach ($hostid as $hostID) {
    ...
    foreach ($result as $host) {
        ...
        "hostids" => $hostID,
        "search" => array("name" => "Event ID 4740 : A user account was locked out"), //seach id contains specific word
        );
        //call api method
...
<!-- HTML -->
<div id="chart4740_div" style="<?php echo $chart_style;?>"></div>
...
var chart_4740 = am4core.create("chart4740_div", am4charts.XYChart);
chart_4740.hiddenState.properties.opacity = 0; // this creates initial fade-in
//chart_4740.fontSize = 10;

/*var title = chart_4740.titles.create();
title.text = '<?php echo $chart_title; ?>';
title.fontSize = 25;
title.marginBottom = 30;
title.align = 'center';*/

chart_4740.paddingRight = 30;
chart_4740.dateFormatter.inputDateFormat = "dd-MM-yyyy HH:mm:ss a";

chart_4740.dateFormatter.dateFormat = "dd-MM-yyyy HH:mm:ss a";
chart_4740.dateFormatter.inputDateFormat = "dd-MM-yyyy HH:mm:ss a";

var categoryAxis = chart_4740.yAxes.push(new am4charts.CategoryAxis());
categoryAxis.dataFields.category = "category";
categoryAxis.renderer.grid.template.location = 0;
categoryAxis.renderer.inversed = true;

var dateAxis = chart_4740.xAxes.push(new am4charts.DateAxis());
...
chart_4740.data = <?php print $itemseries; ?>

var series1 = chart_4740.series.push(new am4charts.ColumnSeries());
...
chart_4740.scrollbarX = new am4core.Scrollbar();
