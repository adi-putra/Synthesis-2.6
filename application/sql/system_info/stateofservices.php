...
<body>
	<table id="stateofservices" class="table table-bordered table-striped">
		<thead>
			<tr>
	          <th>ID</th>
	          <th>Name</th>
	      ...
	      <tbody>
	        <?php
	          ...
	          "hostids" => $hostid,
	          "search" => array("name" => "state of service")//seach id contains specific word
	          );
	          //call api method
