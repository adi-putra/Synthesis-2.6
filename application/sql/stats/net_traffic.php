...
<body>
  ...
  $params = array(
    ...
    "hostids" => $hostid,
    "search" => array("name" => array("incoming traffic", "inbound", "Incoming network")), //seach id contains specific word
    "searchByAny" => true
  );
  //call api method
  ...
  $params = array(
    "output" => array("itemid", "name"),
    "hostids" => $hostid,
    "search" => array("name" => array("outgoing traffic", "outbound", "Outgoing network")), //seach id contains specific word
    "searchByAny" => true
  );
  //call api method
  $result = $zbx->call('item.get', $params);
