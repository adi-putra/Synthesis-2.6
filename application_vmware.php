                                        ...
                                        <td>
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                $params = array(
                                                  "output" => array("groupid", "name"),
                                                  "search" => array("name" => "192"),
                                                );
                                                $result = $zbx->call('hostgroup.get', $params);
                                                foreach ($result as $row) {
                                                  if ($row["groupid"] == 37  || $row["groupid"] == 75) {
                                                    continue;
                                                  }
                                                  else {
                                                    $getgroupid = $row["groupid"];
                                                  ...
                                                  print "<option value='application_vmware.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <div class="row" id="mycontent">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    ...
                    <li><input type="checkbox" class="sub-box" value="vmware-uptime" checked><a href="#vmware-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="hyper-powerstate" checked><a href="#hyper-powerstate">Hypervisor and Power State</a></li>
                    <li><input type="checkbox" class="sub-box" value="cpu-util" checked><a href="#cpu-util">CPU Usage</a></li>
                    <li><input type="checkbox" class="sub-box" value="read-numberbytes" checked><a href="#read-numberbytes">Average Number of Bytes Read</a></li>
                    <li><input type="checkbox" class="sub-box" value="write-numberbytes" checked><a href="#write-numberbytes">Average Number of Bytes Write</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                    ...
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            $("#loadabout").load("ajax/vm/getabout_vmware.php?groupid=" + groupid + "&" + hostArr);
                          </script>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" id="vmware-uptime">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getuptime"></div>        
                            <script>
                              ...
                              function loadUptime() {      
                                //console.log("load");           
                                $("#getuptime").load("ajax/vm/getuptime.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="hyper-powerstate">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Hypervisor and Power State</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="hypervisor_powerstate"></div>        
                            <script>
                              loadHighpervisorPowerState();
                              if (diff <= 604800 && timetill == "") {
                                var hypervisor_powerstate = setInterval(loadHighpervisorPowerState, 60000);
                              }
                              function loadHighpervisorPowerState() {      
                                //console.log("load");           
                                $("#hypervisor_powerstate").load("ajax/vm/hypervisor_powerstate.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                        ...
                        <div class="box-body">
                          <div id="getcpugraph"></div>        
                            <script>
                              loadCPUUsage();
                              if (diff <= 604800 && timetill == "") {
                                var getcpugraph = setInterval(loadCPUUsage, 60000);
                              }
                              function loadCPUUsage() {      
                                //console.log("load");           
                                $("#getcpugraph").load("ajax/vm/getcpugraph.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="read-numberbytes">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">VMWare: Average number bytes read from the disk</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="read_numberbytes"></div>        
                            <script>
                              loadReadBytes();
                              if (diff <= 604800 && timetill == "") {
                                var read_numberbytes = setInterval(loadReadBytes, 60000);
                              }
                              function loadReadBytes() {      
                                //console.log("load");           
                                $("#read_numberbytes").load("ajax/vm/read_numberbytes.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="write-numberbytes">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">VMWare: Average number bytes write from the disk</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="write_numberbytes"></div>        
                            <script>
                              loadWriteBytes();
                              if (diff <= 604800 && timetill == "") {
                                var write_numberbytes = setInterval(loadWriteBytes, 60000);
                              }
                              function loadWriteBytes() {      
                                //console.log("load");           
                                $("#write_numberbytes").load("ajax/vm/write_numberbytes.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
