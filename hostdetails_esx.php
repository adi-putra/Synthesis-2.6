      ...
      <script>
        ...
        function loadCPUPercGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#cpu_percentage").load("hostdetails/esx/performance/cpu_percentage.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadNumProGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#num_processes").load("hostdetails/esx/performance/num_processes.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadUsedMemGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#used_memory").load("hostdetails/esx/performance/used_memory.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadESXiGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#used_esximem").load("hostdetails/esx/performance/used_esximem.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadBalloonedGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#ballooned_mem").load("hostdetails/esx/performance/ballooned_mem.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadBytesSendGraph(hostid, timerange) {
          var interval = setInterval(function() {
            timefrom = '<?php echo $timefrom; ?>';
            if (timetill == currTime) {
              timetill = Math.floor(Date.now() / 1000);
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#bytes_send").load("hostdetails/esx/performance/bytes_send.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadBytesReceivedGraph(hostid, timerange) {
          var interval = setInterval(function() {
            timefrom = '<?php echo $timefrom; ?>';
            if (timetill == currTime) {
              timetill = Math.floor(Date.now() / 1000);
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#bytes_received").load("hostdetails/esx/performance/bytes_received.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadDiskSpaceGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#diskspace").load("hostdetails/esx/capacity/diskspace.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        <div class="row">
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentCPU() {
                      $("#current_cpu").load("hostdetails/esx/cards/current_cpu.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <h3>
                  <div id="current_mem"></div>
                  <script>
                    loadCurrentMem();
                    var current_mem = setInterval(loadCurrentMem, 60000);

                    function loadCurrentMem() {
                      $("#current_mem").load("hostdetails/esx/cards/current_mem.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <h3>
                  <div id="current_esximem"></div>
                  <script>
                    loadCurrentESXIMem();
                    var current_mem = setInterval(loadCurrentESXIMem, 60000);

                    function loadCurrentESXIMem() {
                      $("#current_esximem").load("hostdetails/esx/cards/current_esximem.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                  Current Used ESXI Memory (%)
                </p>
                <div class="icon">
                  <i class="fa fa-memory"></i>
                </div>
              </div>
              <a href="#used_esximem" class="small-box-footer">
                More info <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div><!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <h3>
                  <div id="current_balloon"></div>
                  <script>
                    loadCurrentBalloon();
                    var current_mem = setInterval(loadCurrentBalloon, 60000);

                    function loadCurrentBalloon() {
                      $("#current_balloon").load("hostdetails/esx/cards/current_balloon.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                  Current Ballooned Memory
                </p>
                <div class="icon">
                  <i class="fa fa-memory"></i>
                </div>
              </div>
              <a href="#ballooned_mem" class="small-box-footer">
                More info <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div><!-- ./col -->
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="small-box bg-purple">
              <div class="inner">
                <div id="num_machines"></div>
                <script>
                  loadNumMachines();
                  var current_processes = setInterval(loadNumMachines, 60000);

                  function loadNumMachines() {
                    $("#num_machines").load("hostdetails/esx/cards/num_machines.php?hostid=" + hostid);
                  }
                </script>
                <p>
              ...
              <a href="#virtual_machines" class="small-box-footer">
                More info <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div><!-- ./col -->
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProc() {
                      $("#current_processes").load("hostdetails/esx/cards/current_processes.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProblems() {
                      $("#today_problems").load("hostdetails/esx/cards/today_problems.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                      ...
                      <div id="systeminfo" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="sysinfo"></div>
                            <script>
                              $("#sysinfo").load("hostdetails/esx/system_info/systeminfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="cpu"></div>
                            <script>
                              $("#cpu").load("hostdetails/esx/system_info/cpu.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#sysuptime").load("hostdetails/esx/system_info/sysuptime.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            ...
                            ?>
                            <span class='badge bg-green'><?php echo $vmOnCount; ?></span>
                            <span class='badge bg-red'><?php echo $vmOffCount; ?></span>
                            <span class='badge bg-aqua'><?php echo $vmUnCount; ?></span>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class="box-body">
                            ...
                            <script>
                              $("#virtual_machines").load("hostdetails/esx/system_info/virtual_machines.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                      </div>
                      ...
                      <div id="performance" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Bytes Send Graph</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            <div id='bytes_send'></div>
                            <script>
                              loadBytesSendGraph(hostid, timerange);
                            </script>
                          </div>
                        </div>
                      ...
                      <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Bytes Received Graph</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            ...
                            <script>
                              loadBytesReceivedGraph(hostid, timerange);
                            </script>
                          </div>
                        </div>
                      ...
                      <div id="capacity" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default" style="height: auto;">
                          ...
                          <div class='box-body'>
                            ...
                            <script>
                              $("#diskspace_pie").load("hostdetails/esx/capacity/diskspace_pie.php?hostid=" + hostid + "&timefrom=" + timefrom + "&timetill=" + timetill);
                            </script>
                          </div>
                        </div>
                      </div>
