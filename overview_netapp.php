                                        ...
                                        <div class="form-group" style="display: inline-block;">
                                          <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                            ...
                                            $params = array(
                                              ...
                                              print "<option value='overview_linux.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                            }
                                            ?>
                                          </select>
                                        </div>
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="netapp-problems" checked><a href="#netapp-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-about" checked><a href="#netapp-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-node" checked><a href="#netapp-node">Node</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-volinfo" checked><a href="#netapp-volinfo">Volume Info</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-volcapacity" checked><a href="#netapp-volcapacity">Volume Capacity</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-aggrinfo" checked><a href="#netapp-aggrinfo">Aggregate Info</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-aggrcapacity" checked><a href="#netapp-aggrcapacity">Aggregate Capacity</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-luncapacity" checked><a href="#netapp-luncapacity">LUN Capacity</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-vif" checked><a href="#netapp-vif">VIF</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-volcap-graph" checked><a href="#netapp-volcap-graph">Volume Capacity Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-aggrcap-graph" checked><a href="#netapp-aggrcap-graph">Aggregate Capacity Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-lunlatency-graph" checked><a href="#netapp-lunlatency-graph">LUN Latency Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="netapp-luniops-graph" checked><a href="#netapp-luniops-graph">LUN IOPS Graph</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                <div class="box-body">
                  ...
                  <div class="row" id="netapp-problems">
                    <div class="col-md-12">
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadAbout();
                            if (diff <= 604800 && timetill == "") {
                              var loadabout = setInterval(loadAbout, 300000);
                            }
                            
                            function loadAbout() {      
                              //console.log("load");           
                              $("#loadabout").load("ajax/netapp/getabout.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadNodes();
                            if (diff <= 604800 && timetill == "") {
                              var getnodes = setInterval(loadNodes, 300000);
                            }
                            
                            function loadNodes() {      
                              //console.log("load");           
                              $("#getnodes").load("ajax/netapp/getnodes.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-volinfo">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getvolumeinfo"></div>
                          <script>
                            loadVolumeInfo();
                            if (diff <= 604800 && timetill == "") {
                              var getvolumeinfo = setInterval(loadVolumeInfo, 300000);
                            }
                            
                            function loadVolumeInfo() {      
                              //console.log("load");           
                              $("#getvolumeinfo").load("ajax/netapp/getvolumeinfo.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-volcapacity">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getvolumecap"></div>
                          <script>
                            loadVolumeCap();
                            if (diff <= 604800 && timetill == "") {
                              var getvolumecap = setInterval(loadVolumeCap, 300000);
                            }
                            
                            function loadVolumeCap() {      
                              //console.log("load");           
                              $("#getvolumecap").load("ajax/netapp/getvolumecap.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-aggrinfo">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getaggrinfo"></div>
                          <script>
                            loadAggrInfo();
                            if (diff <= 604800 && timetill == "") {
                              var getaggrinfo = setInterval(loadAggrInfo, 300000);
                            }
                            
                            function loadAggrInfo() {      
                              //console.log("load");           
                              $("#getaggrinfo").load("ajax/netapp/getaggrinfo.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-aggrcapacity">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getaggrcapacity"></div>
                          <script>
                            loadAggrCapacity();
                            if (diff <= 604800 && timetill == "") {
                              var getaggrcapacity = setInterval(loadAggrCapacity, 300000);
                            }
                            
                            function loadAggrCapacity() {
                              //console.log("load");           
                              $("#getaggrcapacity").load("ajax/netapp/getaggrcapacity.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-luncapacity">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getluncap"></div>
                          <script>
                            loadLUNCapacity();
                            if (diff <= 604800 && timetill == "") {
                              var getluncap = setInterval(loadLUNCapacity, 300000);
                            }
                            
                            function loadLUNCapacity() {
                              //console.log("load");           
                              $("#getluncap").load("ajax/netapp/getluncap.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadVIF();
                            if (diff <= 604800 && timetill == "") {
                              var getvif = setInterval(loadVIF, 300000);
                            }
                            
                            function loadVIF() {
                              //console.log("load");           
                              $("#getvif").load("ajax/netapp/getvif.php?groupid=" + groupid + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-cpuusage-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">CPU Usage Graph (%)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getcpu_graph"></div>
                          <script>
                            loadCPUUsageGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getcpu_graph = setInterval(loadCPUUsageGraph, 300000);
                            }
                            
                            function loadCPUUsageGraph() {
                              //console.log("load");           
                              $("#getcpu_graph").load("ajax/netapp/getcpu_graph.php?groupid=" + groupid + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-volcap-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Volume Capacity Graph (%)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getvolcap_graph"></div>
                          <script>
                            loadVolCapGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getvolcap_graph = setInterval(loadVolCapGraph, 300000);
                            }
                            
                            function loadVolCapGraph() {
                              //console.log("load");           
                              $("#getvolcap_graph").load("ajax/netapp/getvolcap_graph.php?groupid=" + groupid + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-aggrcap-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Aggregate Capacity Graph (%)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getaggrcap_graph"></div>
                          <script>
                            loadAggrCapGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getaggrcap_graph = setInterval(loadAggrCapGraph, 300000);
                            }
                            
                            function loadAggrCapGraph() {
                              //console.log("load");           
                              $("#getaggrcap_graph").load("ajax/netapp/getaggrcap_graph.php?groupid=" + groupid + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <!-- <div class="row" id="netapp-luncap-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">LUN Capacity Graph (%)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getluncap_graph"></div>
                          <script>
                            loadLUNCapGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getluncap_graph = setInterval(loadLUNCapGraph, 300000);
                            }
                            
                            function loadLUNCapGraph() {
                              //console.log("load");           
                              $("#getluncap_graph").load("ajax/netapp/getluncap_graph.php?groupid=" + groupid + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-lunlatency-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">LUN Latency Graph (ms)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getlunlatency_graph"></div>
                          <script>
                            loadLUNLatencyGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getlunlatency_graph = setInterval(loadLUNLatencyGraph, 300000);
                            }
                            
                            function loadLUNLatencyGraph() {
                              //console.log("load");           
                              $("#getlunlatency_graph").load("ajax/netapp/getlunlatency_graph.php?groupid=" + groupid + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="netapp-luniops-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">LUN IOPS Graph (ms)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getluniops_graph"></div>
                          <script>
                            loadLUNIOPSGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getluniops_graph = setInterval(loadLUNIOPSGraph, 300000);
                            }
                            
                            function loadLUNIOPSGraph() {
                              //console.log("load");           
                              $("#getluniops_graph").load("ajax/netapp/getluniops_graph.php?groupid=" + groupid + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
