...
$json_resolved = mb_convert_encoding($resolved_data, 'UTF-8', 'UTF-8');
$json_resolved = json_encode($json_resolved);
...
<script type="text/javascript">
    ...
    var reportpivot = $("#resolved-report").flexmonster({
        ...
        toolbar: true,
        beforetoolbarcreated: customizeResolvedToolbar,
    ...
    function customizeResolvedToolbar(toolbar) {
        // get all tabs 
