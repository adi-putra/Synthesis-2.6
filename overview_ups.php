      ...
      <div class="row">
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                foreach ($result as $row) {
                                                  ...
                                                  print "<option value='overview_ups.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <script>
          ...
          function loadAllGraph(timefrom, timetill) {
            ...
            loadOutloadGraph(hostArr, timerange);
            loadTempGraph(hostArr, timerange);
            loadInputGraph(hostArr, timerange);
            loadOutputGraph(hostArr, timerange);

            return true;
          }


          function loadOutloadGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadoutloadchart").load("ajax/ups/getoutloadgraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadTempGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadtempchart").load("ajax/ups/gettempgraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadInputGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadinputchart").load("ajax/ups/getinputgraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadOutputGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadoutputchart").load("ajax/ups/getoutputgraph.php?" + hostArr + timerange);
            }, 60000);
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="ups-problems" checked><a href="#ups-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="ups-about" checked><a href="#ups-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="ups-uptime" checked><a href="#ups-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="battery-charge" checked><a href="#battery-charge">Battery Charge</a></li>
                    <li><input type="checkbox" class="sub-box" value="battery-runtime" checked><a href="#battery-runtime">Battery Runtime</a></li>
                    <li><input type="checkbox" class="sub-box" value="output-load" checked><a href="#output-load">Output Load</a></li>
                    <li><input type="checkbox" class="sub-box" value="battery-temperature" checked><a href="#battery-temperature">Battery Temperature</a></li>
                    <li><input type="checkbox" class="sub-box" value="input-voltage" checked><a href="#input-voltage">Input Voltage</a></li>
                    <li><input type="checkbox" class="sub-box" value="output-voltage" checked><a href="#output-voltage">Ouput Voltage</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            $("#loadabout").load("ajax/ups/getabout.php?groupid=" + groupid + "&" + hostArr);
                          </script>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" id="battery-charge">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Battery Charge Status</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadbatcharge"></div>
                          <script>
                            //load chart from getcpugraph.php page and send get request
                            $("#loadbatcharge").load("ajax/ups/getbatcharge.php?" + hostArr + timerange);
                            //set chart refresh for every 60000 miliseconds
                            //create new timefrom and timetill using js
                            setInterval(function() {
                              var d = new Date();
                  ...
                  <div class="row" id="battery-runtime">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Battery Runtime Graph</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadruntimechart"></div>
                          <script>
                            //load chart from getcpugraph.php page and send get request
                            $("#loadruntimechart").load("ajax/ups/getruntimegraph.php?" + hostArr + timerange);
                            //set chart refresh for every 60000 miliseconds
                            //create new timefrom and timetill using js
                            setInterval(function() {
                              var d = new Date();
                  ...
                  <div class="row" id="output-load">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Output Load</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadoutloadchart"></div>
                          <script>
                            //load chart from getoutloadgraph.php page and send get request
                            if (counthost < 30) {
                              loadOutloadGraph(hostArr, timerange);
                            }
                          </script>
                  ...
                  <div class="row" id="battery-temperature">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Battery Temperature</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadtempchart"></div>
                          <script>
                            //load chart from getoutloadgraph.php page and send get request
                            if (counthost < 30) {
                              loadTempGraph(hostArr, timerange);
                  ...
                  <div class="row" id="input-voltage">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Current Input Voltage</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadinputchart"></div>
                          <script>
                            //load chart from getoutloadgraph.php page and send get request
                            if (counthost < 30) {
                              loadInputGraph(hostArr, timerange);
                  ...
                  <div class="row" id="output-voltage">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Current Ouput Voltage</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadoutputchart"></div>
                          <script>
                            //load chart from getoutloadgraph.php page and send get request
                            if (counthost < 30) {
                              loadOutputGraph(hostArr, timerange);
