              ...
              if ($row["name"] != $hostname) {
                ...
                foreach ($row["groups"] as $group) {
                  ...
                  if (stripos($getgroupname, "sql")) {
                    print "<option value='application_sql_performance.php?hostid=" . $gethostid . "'>$gethostname</option>";
                  }
                }
              } else {
                continue;
                      ...
                      <div class="box-body">
                        <div class="col-sm-12">
                          <div class="box" style="background-color: #3c8dbc;">
                            ...
                            <div class="box-body">
                              <form action="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                                      <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                          <li><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                          <li><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 hour</a></li>
                                          <li><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 day</a></li>
                                          <li><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 2 days</a></li>
                                          <li><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 7 days</a></li>
                                          <li><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 month</a></li>
                          ...
                          <div class="col-xs-12">
                            <aside class="col-lg-2 col-md-3 col-sm-12">
                              ...
                              <li><input type="checkbox" class="sub-box" value="backupstatus" checked><a href="#backupstatus">SQL Backup Failed</a></li> -->
                                      ...
                                      <li class="active"><a href="application_sql_performance.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">Performance</a></li>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">SQL Stats Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="sql_stat"></div>
                                  <script>
                                    loadSQLStatGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default" id="userconn">
                                ...
                                <div class='box-body'>
                                  <div id="user_connection1"></div>
                                  <script>
                                    loadUserConn1Graph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">Access Methods</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="access_method"></div>
                                  <script>
                                    loadAccMethodGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="logflush">
                                <div class="box-header">
                                  <h3 class="box-title">Log Flushes/sec Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="log_flushes"></div>
                                  <script>
                                    loadLogFlushGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">Replica/Mirroring Statistics Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="replica_mirror"></div>
                                  <script>
                                    loadReplicaMirrorGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="transdelay">
                                <div class="box-header">
                                  <h3 class="box-title">Transaction Delay Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="trans_delay"></div>
                                  <script>
                                    loadTransDelayGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">Database Activity / Transaction Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='db_activity'></div>
                                  <script>
                                    loadDBActivityGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">Wait Stats Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='wait_stat'></div>
                                  <script>
                                    loadWaitStatGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">Error/sec Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='errors'></div>
                                  <script>
                                    loadErrorsGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
