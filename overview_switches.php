...
//initiate host ids
//if groupname is cinema, group by brand name
$counthost1 = 0;
$hostids = array();
if (stripos($getgroupname, "cinema") !== false) {
  $params = array(
  ...
  foreach ($result as $row) {
    if ($brand == "HP") {
      if (strpos($row["name"], "HPE") !== false) {
        continue;
      }
      else {
        if (strpos($row["name"], $brand) !== false) {
...
<body class="skin-blue">
      ...
      <div class="row">
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                foreach ($result as $row) {
                                                  $getgroupid = $row["groupid"];
                                                  $getgroupname = $row["name"];
                                                  if ($row["name"] != $groupname && $row["name"] != "Switches") {
                                                    $getgroupname = $row["name"];
                                                  } else {
                                                    continue;
                                                  }
                                                  print "<option value='overview_switches.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <script>
          ...
          function loadAllGraph(timefrom, timetill) {
            ...
            loadReceiveGraph(hostArr, timerange);
            loadSentGraph(hostArr, timerange);
            loadInboundGraph(hostArr, timerange);
          ...
          function loadResponseGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              ...
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadresponsechart").load("ajax/switches/getresponsegraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadReceiveGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadreceivechart").load("ajax/switches/getreceivegraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadSentGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadsentchart").load("ajax/switches/getsentgraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadInboundGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadinboundchart").load("ajax/switches/getinboundgraph.php?" + hostArr + timerange);
            }, 60000);
          ...
          function loadOutboundGraph(hostArr, timerange) {
            var interval = setInterval(function() {
              timefrom = '<?php echo $timefrom; ?>';
              timetill = Math.floor(Date.now() / 1000);
              timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
              $("#loadoutboundchart").load("ajax/switches/getoutboundgraph.php?" + hostArr + timerange);
            }, 60000);
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="switches-problems" checked><a href="#switches-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="switches-about" checked><a href="#switches-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="response-time" checked><a href="#response-time">Response Time</a></li>
                    <li><input type="checkbox" class="sub-box" value="switches-uptime" checked><a href="#switches-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="received-graph" checked><a href="#received-graph">Bandwidth (Bits Received)</a></li>
                    <li><input type="checkbox" class="sub-box" value="sent-graph" checked><a href="#sent-graph">Bandwidth (Bits Sent)</a></li>
                    <li><input type="checkbox" class="sub-box" value="inbound-graph" checked><a href="#inbound-graph">Inbound</a></li>
                    <li><input type="checkbox" class="sub-box" value="outbound-graph" checked><a href="#outbound-graph">Outbound</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                <div class="box-body">
                  ...
                  <div class="row" id="switches-problems">
                    <div class="col-md-12">
                  ...
                  <div class="row" id="switches-about">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            $("#loadabout").load("ajax/switches/getabout.php?groupid=" + groupid + "&" + hostArr);
                          </script>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" id="switches-uptime">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            ...
                            $("#loaduptime").load("ajax/switches/getuptime.php?" + hostArr + timerange);
                  ...
                  <div class="row" id="received-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Bandwidth (Bits Received)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadreceivechart"></div>
                          <script>
                            //load chart from getreceivegraph.php page and send get request
                  ...
                  <div class="row" id="sent-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Bandwidth (Bits Sent)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadsentchart"></div>
                          <script>
                            //load chart from getsentgraph.php page and send get request
                  ...
                  <div class="row" id="inbound-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Inbound | Packer Error vs Packet Drops</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadinboundchart"></div>
                          <script>
                            //load chart from getinboundgraph.php page and send get request
                  ...
                  <div class="row" id="outbound-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Outbound | Packer Error vs Packet Drops</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadoutboundchart"></div>
                          <script>
                            //load chart from getoutboundgraph.php page and send get request
                            
                              loadOutboundGraph(hostArr, timerange);
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#problems').DataTable({
        "ajax": 'ajax/switches/getevents.php',
