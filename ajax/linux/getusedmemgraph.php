...
if ($memoryutilSeries == "") {
  ...
  print '<div id="memoryutilchart" style="width: auto;height: 400px;"></div>
...
memoryutil_chart.legend.scrollable = true;
...
memoryutil_chart.exporting.adapter.add("data", function(data, target) {
    // Assemble data from series
    var data = [];
    memoryutil_chart.series.each(function(series) {
