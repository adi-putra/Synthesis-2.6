...
<body>
	...
	<div class="col-md-12">
	<!-- CPU Util table -->
	<table id="spaceutil_table" class="table table-bordered table-striped">
					...
					foreach ($hostid as $hostID) {
						...
						//Current Disk Percentage
	                      $params = array(
	                        ...
	                        "hostids" => $hostID,
	                        "search" => array("name" => array("(percentage)", "space utilization")),//seach id contains specific word
							"searchByAny" => true
						  );
	                      //call api method
	                      ...
	                      foreach ($result as $item) {
							...
							print '<tr>
									<td><a href="hostdetails_linux.php?hostid='.$hostID.'#capacity" target="_blank">'.$hostname.":</a> ".$itemname.'</td>
									<td>
