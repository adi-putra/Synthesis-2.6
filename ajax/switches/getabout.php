	...
	if (isset($hostid)) {
		...
		foreach ($result as $item) {
			...
			if ($sysver1 == "" || $sysver1 == "0") {
				...
				$sysver[] = substr($sysver1, strpos($sysver1, "YA"));
				$sysver[] = substr($sysver1, strpos($sysver1, "KB"));
				$sysver[] = substr($sysver1, strpos($sysver1, "WC"));
			}
		}
			...
			foreach ($vervalues as $value => $count) {
				foreach ($hostid as $hostID) {
					...
					foreach ($result as $item) {
						...
						$lastvalue = substr($lastvalue, strpos($lastvalue, "YA"));
						$lastvalue = substr($lastvalue, strpos($lastvalue, "KB"));
						$lastvalue = substr($lastvalue, strpos($lastvalue, "WC"));
