				...
				<tbody>
					...
					foreach ($hostid as $hostID) {
						...
						$params = array(
							"output" => array("itemid"),
							"hostids" => $hostID,
							"search" => array("name" => array("memory util", "used memory")), //seach id contains specific word
        					"searchByAny" => true
						);
						//call api method
						...
						print '<tr>
                    			<td><a href="hostdetails_windows.php?hostid=' . $hostID . '#performance" target="_blank">' . $hostname . '</a></td>
	                              <td>
