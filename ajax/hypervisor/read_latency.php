...
foreach ($hostid as $hostID) {
    ...
    foreach ($result as $host) {
        ...
        "hostids" => $hostID,
        "search" => array("name" => "average read latency"), //seach id contains specific word
        );
        //call api method
...
if ($readlatencySeries == "") {
  print '<h5 style="color: red;">No data available</h5>';
}
else {
  print '<div id="readlatencychart" style="width: auto;height: 400px;"></div>
...
readlatency_chart.numberFormatter.numberFormat = "#.## 'ms'";
//readlatency_chart.fontSize = 12;

var title = readlatency_chart.titles.create();
title.text = 'Average Read Latency';
title.fontSize = 25;
