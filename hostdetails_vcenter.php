    ...
    <div class="content-wrapper">
        ...
        <div class="form-group">
          ...
          <select onclick="sortList()" id="hostlist_sel"class="form-control" name="selecthost" onchange="location = this.value;" style="display: inline-block; width: auto;">
            ...
            foreach ($result as $row) {
              ...
              //   print "<option value='hostdetails_vcenter.php?hostid=" . $gethostid . "' selected>$gethostname</option>";

              // }
              print "<option value='hostdetails_vcenter.php?hostid=" . $gethostid . "'>$gethostname</option>";
      ...
      <script>
        ...
        function loadSystemLog(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            $("#window_syslog").load("hostdetails/vcenter/issues/vcenter_syslog.php?hostid=" + hostid + timerange);
          }, 60000);
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-xs-6">
            <!-- small box -->
            <div id="clusterstatusdiv" class="small-box bg-gray">
              <div class="inner">
                <h3>
                  <div id="clusterstatus"></div>
                  <script>
                    loadClusterStatus();
                    var clusterstatus = setInterval(loadClusterStatus, 60000);

                    function loadClusterStatus() {
                      $("#clusterstatus").load("hostdetails/vcenter/cards/clusterstatus.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProblems() {
                      $("#today_problems").load("hostdetails/vcenter/cards/today_problems.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3>
                  ...
                  <script>
                    loadvcenterr();
                    var vcenter = setInterval(loadvcenterr, 60000);

                    function loadvcenterr() {
                      $("#vcenter").load("hostdetails/vcenter/cards/vcenter.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3>
                  ...
                  <script>
                    loadfullname();
                    var fullname = setInterval(loadfullname, 60000);

                    function loadfullname() {
                      $("#fullname").load("hostdetails/vcenter/cards/fullname.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
              ...
              <div class="box-body">
                ...
                <div class="col-sm-12">
                  <div class="box" style="background-color: #3c8dbc;">
                    ...
                    <div class="box-body">
                      <form action="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                        <div class="row">
                            ...
                            <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                              <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 hour</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 day</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 2 days</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 7 days</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 month</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-3 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 3 months</a></li>
                                  <li><a href="hostdetails_vcenter.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-6 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 6 months</a></li>
                                </ul>
                              </div>
                      ...
                      <div id="systeminfo" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#clusterinfo").load("hostdetails/vcenter/system_info/clusterinfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="sysinfo"></div>
                            <script>
                              $("#sysinfo").load("hostdetails/vcenter/system_info/systeminfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Storage Info</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class="box-body">
                            ...
                            <script>
                              $("#storageinfo").load("hostdetails/vcenter/system_info/storageinfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class='box-body'>
                              ...
                              <script>
                                ...
                                function loadavgReadLatency() {      
                                  //console.log("load");           
                                  $("#avgReadLatency").load("hostdetails/vcenter/performance/avgReadLatencyDatastore.php?hostid[]=" + hostid + timerange);     
                                }
                              </script>
                            </div>
                        </div>
                          ...
                          <div class='box-body'>
                              ...
                              <script>
                                ...
                                function loadavgWriteLatency() {      
                                  //console.log("load");           
                                  $("#avgWriteLatency").load("hostdetails/vcenter/performance/avgWriteLatencyDatastore.php?hostid[]=" + hostid + timerange);     
                                }
                              </script>
                            </div>
                        </div>
                            ...
                            <div class='box-body'>
                              ...
                              <script>
                                ...
                                function loadDiskGraph() {      
                                  //console.log("load");           
                                  $("#disk_graph").load("hostdetails/vcenter/storage/freespaceDatastore.php?hostid[]=" + hostid + timerange);     
                                }
                              </script>
                            </div>
                        </div>
