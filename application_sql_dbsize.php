              ...
              if ($row["name"] != $hostname) {
                ...
                foreach ($row["groups"] as $group) {
                  ...
                  if (stripos($getgroupname, "sql")) {
                    print "<option value='application_sql_dbsize.php?hostid=" . $gethostid . "'>$gethostname</option>";
                  }
                }
              } else {
                continue;
                      ...
                      <div class="box-body">
                        <div class="col-sm-12">
                          <div class="box" style="background-color: #3c8dbc;">
                            ...
                            <div class="box-body">
                              <form action="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                                      <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                          <li><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                          <li><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 hour</a></li>
                                          <li><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 day</a></li>
                                          <li><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 2 days</a></li>
                                          <li><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 7 days</a></li>
                                          <li><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 month</a></li>
                                        </ul>
                                      </div>
                          ...
                          <div class="col-xs-12">
                            <aside class="col-lg-2 col-md-3 col-sm-12">
                              ...
                              <li><input type="checkbox" class="sub-box" value="backupstatus" checked><a href="#backupstatus">SQL Backup Failed</a></li> -->
                                      ...
                                      <li class="active"><a href="application_sql_dbsize.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">Database Size</a></li>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                              ...
                              <div class="box box-solid box-default" style="height: auto;">
                                <div class="box-header">
                                  <h3 class="box-title">Data File Size by Database</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  ...
                                  <script>
                                    $("#datafile_pie").load("application/sql/capacity/datafile_pie.php?hostid=" + hostid + "&timefrom=" + timefrom + "&timetill=" + timetill);
                                  </script>
                                  <div class="row">
                                    <div id="datafile_graph">

                                    </div>
                                  </div>
                                  <script>
                                    $("#datafile_graph").load("application/sql/capacity/datafile_graph.php?hostid=" + hostid + "&timefrom=" + timefrom + "&timetill=" + timetill);
                                  </script>
                                </div>
                              </div>
                              <div class="box box-solid box-default" style="height: auto;">
                                <div class="box-header">
                                  <h3 class="box-title">Log File Size by Database</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  ...
                                  <script>
                                    $("#logfile_pie").load("application/sql/capacity/logfile_pie.php?hostid=" + hostid + "&timefrom=" + timefrom + "&timetill=" + timetill);
                                  </script>
                                  <div class="row">
                                    <div id="logfile_graph">

                                    </div>
                                  </div>
                                  <script>
                                    $("#logfile_graph").load("application/sql/capacity/logfile_graph.php?hostid=" + hostid + "&timefrom=" + timefrom + "&timetill=" + timetill);
                                  </script>
                                </div>
                              </div>
