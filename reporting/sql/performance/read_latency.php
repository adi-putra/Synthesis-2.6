...
readlatency_chart.exporting.extraSprites.push({
  "sprite": legendContainer,
  "position": "bottom",
  "marginTop": 20
});
var groupid = '<?php echo $groupid ?>';
var filename = new Date().toJSON().slice(0,10) + "_" + groupid + "_readlatency";

readlatency_chart.exporting.filePrefix = filename;
readlatency_chart.exporting.useWebFonts = true;
</script>
...
<script>
    ...
    if (graphpng.length == 0) {
        graphpng[0] = readlatency_chart.exporting.pdfmake;
        graphpng[1] = readlatency_chart.exporting.getImage("png");
    }
    else {
        graphpng[graphpng.length] = readlatency_chart.exporting.getImage("png");
    }
    if (countcheck == 13) {
