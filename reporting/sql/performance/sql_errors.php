...
sqlerrors_chart.legend.scrollable = false;
...
sqlerrors_chart.exporting.extraSprites.push({
  "sprite": legendContainer,
  "position": "bottom",
  "marginTop": 20
});
var groupid = '<?php echo $groupid ?>';
var filename = new Date().toJSON().slice(0,10) + "_" + groupid + "_sqlerrors";

sqlerrors_chart.exporting.filePrefix = filename;
sqlerrors_chart.exporting.useWebFonts = true;
</script>
...
<script>
    ...
    if (graphpng.length == 0) {
        graphpng[0] = sqlerrors_chart.exporting.pdfmake;
        graphpng[1] = sqlerrors_chart.exporting.getImage("png");
    }
    else {
        graphpng[graphpng.length] = sqlerrors_chart.exporting.getImage("png");
    }
