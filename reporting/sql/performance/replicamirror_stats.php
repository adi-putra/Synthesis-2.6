...
replicamirrorstats_chart.exporting.extraSprites.push({
  "sprite": legendContainer,
  "position": "bottom",
  "marginTop": 20
});
var groupid = '<?php echo $groupid ?>';
var filename = new Date().toJSON().slice(0,10) + "_" + groupid + "_repmirstats";

replicamirrorstats_chart.exporting.filePrefix = filename;
replicamirrorstats_chart.exporting.useWebFonts = true;
</script>
...
<script>
    ...
    if (graphpng.length == 0) {
        graphpng[0] = replicamirrorstats_chart.exporting.pdfmake;
        graphpng[1] = replicamirrorstats_chart.exporting.getImage("png");
    }
    else {
        graphpng[graphpng.length] = replicamirrorstats_chart.exporting.getImage("png");
    }
