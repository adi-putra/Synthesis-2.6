...
foreach ($hostid as $hostID) {
    ...
    foreach ($result as $host) {
        ...
        "hostids" => $hostID,
        "search" => array("name" => array("Memory Utilization", "Used memory in")), //seach id contains specific word
        "searchByAny" => true
        );
        //call api method
...
title.text = 'Top 10 - Memory Utilization (%)';
title.fontSize = 25;
...
graphpng[3] = memoryutil_chart.exporting.getImage("png");
