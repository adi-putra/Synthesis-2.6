...
foreach ($result as $app) {
    $get_iss_hostid[] = $app["hostid"];
}

//search ISS Groups
$get_iss_groupid = array();
$params = array(
    "output" => array("hostid", "name"),
    "hostids" => $get_iss_hostid,
    "selectGroups" => array("groupid", "name")
);
$result = $zbx->call('host.get', $params);
foreach ($result as $host) {
    foreach ($host["groups"] as $group) {
        if (!in_array($group["groupid"], $get_iss_groupid)) {
            $get_iss_groupid[] = $group["groupid"];
        }
    }
}
...
//$groupid = $_GET["groupid"] ?? $get_iss_groupid[0];
$groupid = $_GET["groupid"] ?? array("68");
...
foreach ($result as $host) {
  ...
  if (in_array($gethostid, $get_iss_hostid)) {
      $hostids[] = $gethostid;
  }
}
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                $params = array(
                                                    "output" => array("hostid", "name"),
                                                    "groupids" => $get_iss_groupid,
                                                );
                                                $result = $zbx->call('hostgroup.get', $params);
                                                foreach ($result as $group) {
                                                    print "<option value='application_iis_overview.php?groupid=" . $group["groupid"] . "'>" . $group["name"] . "</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <div class="row">
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li><input type="checkbox" class="sub-box" value="iisoverview_problems" checked><a href="#iisoverview_problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="iisoverview_status" checked><a href="#iisoverview_status">IIS Status</a></li>
                    <li><input type="checkbox" class="sub-box" value="iisoverview_conn" checked><a href="#iisoverview_conn">IIS Connections</a></li>
                    <li><input type="checkbox" class="sub-box" value="iisoverview_performances" checked><a href="#iisoverview_performances">IIS Performance</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                ...
                <div class="box-body">
                  <div class="row" id="iisoverview_problems">
                    <div class="col-md-12">
                  ...
                  <div class="row" id="iisoverview_status">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">IIS Status</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div class="row">
                            <div class="col-md-12">
                            <div id="iis_status"></div>
                            <script>
                              $("#iis_status").load("application/iis_overview/iis_status/iis_status.php?" + hostArr);
                            </script>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="row" id="iisoverview_conn">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">IIS Connections</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div class="row">
                            ...
                            <script>
                              loadISSConn();
                              if (diff <= 604800 && timetill == "") {
                                var iis_conn = setInterval(loadISSConn, 60000);
                              }
                              function loadISSConn() {      
                                //console.log("load");           
                                $("#iis_conn").load("application/iis_overview/iis_conn/iis_conn.php?" + hostArr + timerange);     
                              }
                            </script>
                            <div id="iis_connsec"></div>
                            <script>
                              loadISSConnSec();
                              if (diff <= 604800 && timetill == "") {
                                var iis_connsec = setInterval(loadISSConnSec, 60000);
                              }
                              function loadISSConnSec() {      
                                //console.log("load");           
                                $("#iis_connsec").load("application/iis_overview/iis_conn/iis_connsec.php?" + hostArr + timerange);     
                              }
                            </script>
                            </div>
                          </div>
                  ...
                  <div class="row" id="iisoverview_performances">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">IIS Performances</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="bytes_sentrec"></div>        
                            <script>
                              loadBytesSentRec();
                              if (diff <= 604800 && timetill == "") {
                                var bytes_sentrec = setInterval(loadBytesSentRec, 60000);
                              }
                              function loadBytesSentRec() {      
                                //console.log("load");           
                                $("#bytes_sentrec").load("application/iis_overview/performance/bytes_sentrec.php?" + hostArr + timerange);     
                              }
                            </script>
                          <div id="filemiss"></div>        
                            <script>
                              loadFileMiss();
                              if (diff <= 604800 && timetill == "") {
                                var filemiss = setInterval(loadFileMiss, 60000);
                              }
                              function loadFileMiss() {      
                                //console.log("load");           
                                $("#filemiss").load("application/iis_overview/performance/filemiss.php?" + hostArr + timerange);     
                              }
                            </script>
                          <div id="filehit"></div>        
                            <script>
                              loadFileHit();
                              if (diff <= 604800 && timetill == "") {
                                var filehit = setInterval(loadFileHit, 60000);
                              }
                              function loadFileHit() {      
                                //console.log("load");           
                                $("#filehit").load("application/iis_overview/performance/filehit.php?" + hostArr + timerange);     
                              }
                            </script>
                          <div id="urlhit"></div>        
                            <script>
                              loadURLHit();
                              if (diff <= 604800 && timetill == "") {
                                var urlhit = setInterval(loadURLHit, 60000);
                              }
                              function loadURLHit() {      
                                //console.log("load");           
                                $("#urlhit").load("application/iis_overview/performance/urlhit.php?" + hostArr + timerange);     
                              }
                            </script>
                          <div id="urlmiss"></div>        
                            <script>
                              loadURLMiss();
                              if (diff <= 604800 && timetill == "") {
                                var urlmiss = setInterval(loadURLMiss, 60000);
                              }
                              function loadURLMiss() {      
                                //console.log("load");           
                                $("#urlmiss").load("application/iis_overview/performance/urlmiss.php?" + hostArr + timerange);     
                              }
                            </script>
                          <div id="iis_method"></div>        
                            <script>
                              loadIISMethod();
                              if (diff <= 604800 && timetill == "") {
                                var iis_method = setInterval(loadIISMethod, 60000);
                              }
                              function loadIISMethod() {      
                                //console.log("load");           
                                $("#iis_method").load("application/iis_overview/performance/iis_method.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
