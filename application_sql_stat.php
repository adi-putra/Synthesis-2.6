              ...
              if ($row["name"] != $hostname) {
                ...
                foreach ($row["groups"] as $group) {
                  ...
                  if (stripos($getgroupname, "sql")) {
                    print "<option value='application_sql_stat.php?hostid=" . $gethostid . "&timefrom=" . $timefrom . "&timetill=" . $timetill . "'>$gethostname</option>";
                  }
                }
              } else {
                continue;
                      ...
                      <div class="box-body">
                        <div class="col-sm-12">
                          <div class="box" style="background-color: #3c8dbc;">
                            ...
                            <div class="box-body">
                              <form action="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                                      <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                          <li><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                          <li><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 hour</a></li>
                                          <li><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 day</a></li>
                                          <li><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 2 days</a></li>
                                          <li><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 7 days</a></li>
                                          <li><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 month</a></li>
                                        </ul>
                                      </div>
                        ...
                        <div class="row" id="mycontent-host">
                          <div class="col-xs-12">
                                ...
                                <div class="box-body show">
                                  <ul class="nav nav-pills nav-stacked application-nav">
                                    ...
                                    <ul class="nav nav-tabs nav-stacked">
                                      ...
                                      <li class="active"><a href="application_sql_stat.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">Quick Stats</a></li>
                                      ...
                                      <li><a href="application_sql_availrep.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">Availability Replica</a></li>
                                    </ul>
                                    <!-- </div> -->
                                  </ul>
                                </div>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                              ...
                              <div class="box box-solid box-default" id="processortime">
                                <div class="box-header">
                                  <h3 class="box-title">Processor Time (%) Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="processor_time"></div>
                                  <script>
                                    loadProcessorTime(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="usedmemory">
                                <div class="box-header">
                              ...
                              <div class="box box-solid box-default" id="dlock">
                                <div class="box-header">
                                  <h3 class="box-title">Deadlock Per Second Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="deadlock"></div>
                                  <script>
                                    loadDeadlockGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="userconn">
                                <div class="box-header">
                                  <h3 class="box-title">User Connections Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="user_connection"></div>
                                  <script>
                                    loadUserConnGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="memoryclerk">
                                <div class="box-header">
                                  <h3 class="box-title">Memory Clerk Buffer Pool Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="memory_clerk"></div>
                                  <script>
                                    loadMemClerkGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="backupthroughput">
                                <div class="box-header">
                                  <h3 class="box-title">Backup/Restore Throughput Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="backup_throughput"></div>
                                  <script>
                                    loadBackupGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>


                              <div class="box box-solid box-default" id="buffercache">
                                <div class="box-header">
                                  <h3 class="box-title">Buffer Cache Hit Ratio Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='buffer_cache'></div>
                                  <script>
                                    loadBufferCacheGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="cpoint">
                                <div class="box-header">
                                  <h3 class="box-title">Checkpoint pages/sec Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  ...
                                  <script>
                                    loadCheckpointGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="pagelookup">
                                <div class="box-header">
                                  <h3 class="box-title">Page lookups/sec</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='page_lookup'></div>
                                  <script>
                                    loadPageLookupGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="freelist">
                                <div class="box-header">
                                  <h3 class="box-title">Free List Stalls/sec</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='free_liststall'></div>
                                  <script>
                                    loadFreeListStallGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="memorygrant">
                                <div class="box-header">
                                  <h3 class="box-title">Memory Grant Pending</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='memory_grant'></div>
                                  <script>
                                    loadMemoryGrantGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="freetempdb">
                                <div class="box-header">
                                  <h3 class="box-title">Free Space in tempdb</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='freespace_tdb'></div>
                                  <script>
                                    loadFreeSpaceTDBGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="activetemptbl">
                                <div class="box-header">
                                  <h3 class="box-title">Active Temporary Tables Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='active_temptbl'></div>
                                  <script>
                                    loadActiveTempTblGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="verstoresize">
                                <div class="box-header">
                                  <h3 class="box-title">Version Store Size Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='version_store'></div>
                                  <script>
                                    loadVersionStoreGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="pagelifeexp">
                                <div class="box-header">
                                  <h3 class="box-title">Page Life Expectancy</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='ple'></div>
                                  <script>
                                    loadPLEGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="totallog">
                                <div class="box-header">
                                  <h3 class="box-title">Data & Log File Size</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id='totallog_used'></div>
                                  <script>
                                    loadTotalLogUsedGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
