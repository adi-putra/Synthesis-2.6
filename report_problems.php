...
<body class="skin-blue">
  <div class="wrapper" style="background-color: white;">
      ...
      <?php
        ...
        //link for report history page
        $rhistory_link = "report_history.php?".$groupArr.$hostArr.$hist_timerange;

        //link for report closed page
        $rclosed_link = "report_closed.php?".$groupArr.$hostArr.$hist_timerange;
      ?>
                    ...
                    <div class="tab-pane active" id="tab_2-2">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href='report_problems.php?&timefrom=<?php echo $timefrom;?>&timetill=<?php echo $timetill;?>'><button class="btn btn-default margin">Reset</button></a>
                            </div>
                        </div>
                    </div><!-- /.tab-pane -->
                    </div><!-- /.tab-content -->
                  ...
                  <div class="box-tools pull-right">
                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <li class="active"><a href="#tab_1" data-toggle="tab">Unresolved Problems</a></li>
                            <li><a href='<?php echo $rhistory_link; ?>'>Resolved Problems (System)</a></li>
                            <li><a href='<?php echo $rclosed_link; ?>'>Closed Problems (User)</a></li>
                            </ul>
                            <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div id="report_problems">
                                    <!-- Loading Gif -->
                                    <div class="overlay">
                                ...
                                <script>
                                    ...
                                    function loadReportProblems() {
                                        $("#report_problems").load("report/report_problems_data.php?" + groupid + hostid + timerange, function( response, status, xhr ) {
                                          if ( status == "error" ) {
                                            var msg = "Info: ";
                                            $( "#report_problems" ).html( msg + xhr.status + " " + xhr.statusText );
                                          }
                                        });
                                    }

                                    //if click button acknowledge problem, stop interval
                                    function stopIntReportProblems() {
                                        console.log("stop prob int");
                                        //clearInterval(report_problems);
                                    }

                                    //if done or close the ack form, start interval back
                                    function startIntReportProblems() {
                                        console.log("start prob int");
                                        //refresh problem table after 1 sec
                                        setTimeout(loadReportProblems, 1000);
                                        //report_problems = setInterval(loadReportProblems, 60000);
                                    }
                                </script>
                            </div><!-- /.tab-pane -->
