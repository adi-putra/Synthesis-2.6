...
foreach ($result as $main) {
    $main_name = $main["name"];
    $main_activesince = date("Y-m-d\TH:i:s", $main["active_since"]);
    $main_activetill = date("Y-m-d\TH:i:s", $main["active_till"]);
    ...
    <?php include("header.php"); ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
           <div class="col-xs-12">
            <form action="maintenance_update.php" method="post" onsubmit="return confirm('Confirm update?');">
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <input type="hidden" name="main_id" value="<?php echo $maintenance_id; ?>"/>
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>Name</th>
                            <td><input class="form-control" style="width: 50%;" type="text" name="main_name" value="<?php echo $main_name; ?>" /></td>
                        </tr>
                        <tr>
                            <th>Active from</th>
                            <td>
                              <input style="width: 50%;" type='datetime-local' class="form-control" name="main_activesince" value="<?php echo $main_activesince; ?>" required />
                            </td>
                        </tr>
                        <tr>
                            <th>Active till</th>
                            <td>
                              <input style="width: 50%;" type='datetime-local' class="form-control" name="main_activetill" value="<?php echo $main_activetill; ?>" required />
                            </td>
                        </tr>
                        <tr>
                          <th>Description</th>
                          <td><textarea class="form-control" id="main_desc" name="main_desc" rows="4" cols="5" style="width: 50%;"><?php echo $main_desc; ?></textarea></td>
                        </tr>
                    </table>
                  </div><!-- /.tab-pane -->
                    ...
                    <table class="table table-bordered table-striped">
                      <tr>
                        ...
                        <td>
                          ...
                          <?php
                          $count = 0;
                          foreach ($main["timeperiods"] as $period) {
                            if ($period["timeperiod_type"] == 0) {
                              print "<tr>";
                              print "<td>";
                              print "One time only";
                              print '<input type="hidden" name="period['.$count.'][timeperiod_type]" value="'.$period["timeperiod_type"].'" />';
                              print '<input type="hidden" name="period['.$count.'][every]" value="'.$period["every"].'" />';
                              print '<input type="hidden" name="period['.$count.'][month]" value="'.$period["month"].'" />';
                              print '<input type="hidden" name="period['.$count.'][dayofweek]" value="'.$period["dayofweek"].'" />';
                              print '<input type="hidden" name="period['.$count.'][day]" value="'.$period["day"].'" />';
                              print '<input type="hidden" name="period['.$count.'][start_time]" value="'.$period["start_time"].'" />';
                              print '<input type="hidden" name="period['.$count.'][period]" value="'.$period["period"].'" />';
                              print '<input type="hidden" name="period['.$count.'][start_date]" value="'.$period["start_date"].'" />';
                              print "</td>";
                              print "<td>";
                              print date("d-m-Y H:i", $period["start_date"]);
                              print "</td>";
                              print "<td>";
                              print secondsToTime($period["period"]);
                              print "</td>";
                              print "</tr>";
                            }  
                            else if ($period["timeperiod_type"] == 2) {
                              print "<tr>";
                              print "<td>";
                              print "Daily";
                              print '<input type="hidden" name="period['.$count.'][timeperiod_type]" value="'.$period["timeperiod_type"].'" />';
                              ...
                              print "</td>";
                              print "<td>";
                              print "At ".secondsToClock($period["start_time"])." every ".$period["every"]." day(s) ";
                              print "</td>";
                              print "<td>";
                              print secondsToTime($period["period"]);
                              print "</td>";
                            ...
                            else if ($period["timeperiod_type"] == 3) {
                              print "<tr>";
                              print "<td>";
                              print "Weekly";
                              print '<input type="hidden" name="period['.$count.'][timeperiod_type]" value="'.$period["timeperiod_type"].'" />';
                              ...
                              print "</td>";
                              print "<td>";
                              print "At ".secondsToClock($period["start_time"])." ".getDayofWeek(decbin($period["dayofweek"]))." every ".$period["every"]." week(s) ";
                              print "</td>";
                              print "<td>";
                              print secondsToTime($period["period"]);
                              print "</td>";
                            ...
                            else if ($period["timeperiod_type"] == 4) {
                              print "<tr>";
                              print "<td>";
                              print "Monthly";
                              print '<input type="hidden" name="period['.$count.'][timeperiod_type]" value="'.$period["timeperiod_type"].'" />';
                              ...
                              print "</td>";
                              print "<td>";
                              print "At ".secondsToClock($period["start_time"])." on day ".$period["day"]." of  every ".getMonth(decbin($period["month"]));
                              print "</td>";
                              print "<td>";
                              print secondsToTime($period["period"]);
                              print "</td>";
                      ...
                      <tr>
                        ...
                        <td>
                          <table id="groupTable" class="table table-bordered table-hover">
                            ...
                            <?php
                            foreach ($main["groups"] as $main_group) {
                              print '<tr>';
                              print '<td>'.$main_group["name"].'</td>';
                              print '<input type="hidden" name="main_groups[]" value="'.$main_group["groupid"].'" />';
                              print '</tr>';
                            }
                            ?>
                          </table>
                      ...
                      <tr>
                        ...
                        <td>
                          <table id="hostTable" class="table table-bordered table-hover">
                            ...
                            <?php
                            foreach ($main["hosts"] as $main_host) {
                              print '<tr>';
                              print '<td>'.$main_host["name"].'</td>';
                              print '<input type="hidden" name="main_hosts[]" value="'.$main_host["hostid"].'" />';
                              print '</tr>';
                            }
                            ?>
                          </table>
              ...
              <a onclick="return confirm('Confirm delete?');" href="maintenance_delete.php?main_id=<?php echo $maintenance_id; ?>"><button class="btn btn-danger margin" type="button">Delete</button></a>
            </form>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </section><!-- /.content -->
