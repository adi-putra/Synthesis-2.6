              ...
              if ($row["name"] != $hostname) {
                ...
                foreach ($row["groups"] as $group) {
                  ...
                  if (stripos($getgroupname, "sql")) {
                    print "<option value='application_sql_dbio.php?hostid=" . $gethostid . "'>$gethostname</option>";
                  }
                }
              } else {
                continue;
                      ...
                      <div class="box-body">
                        <div class="col-sm-12">
                          <div class="box" style="background-color: #3c8dbc;">
                            ...
                            <div class="box-body">
                              <form action="application_sql_dbio.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                                <div class="row">
                          ...
                          <div class="col-xs-12">
                            <aside class="col-lg-2 col-md-3 col-sm-12">
                              ...
                              <li><input type="checkbox" class="sub-box" value="backupstatus" checked><a href="#backupstatus">SQL Backup Failed</a></li> -->
                                      ...
                                      <li class="active"><a href="application_sql_dbio.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">Database I/O</a></li>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">DATA | Read Throughput Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  ...
                                  <script>
                                    loadDataReadGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">DATA | Write Throughput Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="data_write"></div>
                                  <script>
                                    loadDataWriteGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">LOG | Read Throughput Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="log_read"></div>
                                  <script>
                                    loadLogReadGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
                              ...
                              <div class="box box-solid box-default">
                                <div class="box-header">
                                  <h3 class="box-title">LOG | Write Throughput Graph</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class='box-body'>
                                  <div id="log_write"></div>
                                  <script>
                                    loadLogWriteGraph(hostid, timerange);
                                  </script>
                                </div>
                              </div>
