                            ...
                            <div class="form-group" style="display: inline-block;">
                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                ...
                                foreach ($result as $row) {
                                  ...
                                  print "<option value='reporting_netapp.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                }
                                ?>
                              </select>
                            </div>
      ...
      <section class="invoice" id="reportdiv">
        ...
        <div class="row" id="report-title">
          <div class="col-xs-12">
            <h2 class="page-header">
              <i class="fa fa-globe"></i> Netapp Overview - Report
        ...
        <div class="row" id="report-info">
          ...
          <div class="col-xs-12 table-responsive">
            ...
            <div id="getabout"></div>
            <script>
              $("#getabout").load("reporting/netapp/getabout.php?groupid=" + groupid + "&" + hostArr, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Info: ";
        ...
        <div class="row" id="report-node">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Node</p>
            <div id="node"></div>
            <script>
              $("#node").load("reporting/netapp/node.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Node: ";
                  $("#node").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-node')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[3] = img;
                  })
                }
        ...
        <div class="row" id="report-volumeinfo">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Volume Info</p>
            <div id="volumeinfo"></div>
            <script>
              $("#volumeinfo").load("reporting/netapp/volumeinfo.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Volume Info: ";
                  $("#volumeinfo").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-volumeinfo')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[4] = img;
                  })
                }
        ...
        <div class="row" id="report-volumecapacity">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Volume Capacity</p>
            <div id="volumecapacity"></div>
            <script>
              $("#volumecapacity").load("reporting/netapp/volumecapacity.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Volume Capacity: ";
                  $("#volumecapacity").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-volumecapacity')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[5] = img;
                  })
                }
        ...
        <div class="row" id="report-aggrinfo">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Aggregate Info</p>
            <div id="aggrinfo"></div>
            <script>
              $("#aggrinfo").load("reporting/netapp/aggrinfo.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Aggregate Info: ";
                  $("#aggrinfo").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-aggrinfo')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[6] = img;
                  })
                }
        ...
        <div class="row" id="report-aggrcapacity">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Aggregate Capacity</p>
            <div id="aggrcapacity"></div>
            <script>
              $("#aggrcapacity").load("reporting/netapp/aggrcapacity.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Aggregate Capacity: ";
                  $("#aggrcapacity").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-aggrcapacity')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[7] = img;
                  })
                }
        ...
        <div class="row" id="report-luncapacity">
          <div class="col-xs-12 table-responsive">
            <p class="lead">LUN Capacity</p>
            <div id="luncapacity"></div>
            <script>
              $("#luncapacity").load("reporting/netapp/luncapacity.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "LUN Capacity: ";
                  $("#luncapacity").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-luncapacity')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[8] = img;
                  })
                }
        ...
        <div class="row" id="report-vif">
          <div class="col-xs-12 table-responsive">
            <p class="lead">VIF</p>
            <div id="vif"></div>
            <script>
              $("#vif").load("reporting/netapp/vif.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "VIF: ";
                  $("#vif").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-vif')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[9] = img;
                  })
                }
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="cpuusage_graph"></div>
            <script>
              $("#cpuusage_graph").load("reporting/netapp/cpuusage_graph.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Top 10: CPU Usage (%): ";
                  $("#cpuusage_graph").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="volumecap_graph"></div>
            <script>
              $("#volumecap_graph").load("reporting/netapp/volumecap_graph.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Top 10: Volume Used Capacity (%): ";
                  $("#volumecap_graph").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="aggrcap_graph"></div>
            <script>
              $("#aggrcap_graph").load("reporting/netapp/aggrcap_graph.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Top 10: Aggregate Used Capacity (%): ";
                  $("#aggrcap_graph").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="lunlatency_graph"></div>
            <script>
              $("#lunlatency_graph").load("reporting/netapp/lunlatency_graph.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Top 10: LUN Latency (%): ";
                  $("#lunlatency_graph").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="luniops_graph"></div>
            <script>
              $("#luniops_graph").load("reporting/netapp/luniops_graph.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Top 10: LUN IOPS (ms): ";
                  $("#luniops_graph").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
