  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        $formlink = "overview_vcenter.php?" . $hostArr;

        $timerange = "&timefrom=" . $timefrom . "&timetill=" . $timetill;
        ?>

        <!--<form action="overview_vcenter.php?<?php echo $hostArr; ?>timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">-->
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                foreach ($result as $row) {
                                                  ...
                                                  print "<option value='overview_vcenter.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <div class="row" id="mycontent">
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="vcenter-problems" checked><a href="#vcenter-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="vcenter-eventlog" checked><a href="#vcenter-eventlog">Event Log</a></li>
                    <li><input type="checkbox" class="sub-box" value="vcenter-about" checked><a href="#vcenter-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="vcenter-cluster" checked><a href="#vcenter-cluster">Cluster</a></li>
                    <li><input type="checkbox" class="sub-box" value="vcenter-freedisk" checked><a href="#vcenter-freedisk">Free Disk Space</a></li>
                    <li><input type="checkbox" class="sub-box" value="vcenter-readlatencygraph" checked><a href="#vcenter-readlatencygraph">Average Read Latency Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="vcenter-writelatencygraph" checked><a href="#vcenter-writelatencygraph">Average Write Latency Graph</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
              ...
              <div class="box-body">
                <div class="row" id="vcenter-problems">
                  <div class="col-md-12">
                ...
                <div class="row" id="vcenter-eventlog">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                      ...
                      <div class="box-body">
                        ...
                        <script>
                          ...
                          function loadEventLog() {      
                            //console.log("load");           
                            // $("#loadabout").load("ajax/vcenter/getabout.php?groupid=" + groupid + "&" + hostArr);
                            event_log = $.ajax({
                              url: "ajax/vcenter/event_log.php?groupid=" + groupid + hostArr + timerange, 
                              success: function(result) {
                                $("#event_log").html(result);
                              },
                              complete: function() {
                                if (diff <= 604800 && timetill == "") {
                                  // var problems_table = setTimeout(loadProblemsTable, 60000);
                                  setTimeout(loadEventLog, 60000);
                                }
                                // setTimeout(loadProblemsTable, 60000);
                              }
                            });
                ...
                <div class="row" id="vcenter-about">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                      ...
                      <div class="box-body">
                        ...
                        <script>
                          ...
                          function loadAbout() {      
                            ...
                            // $("#loadabout").load("ajax/vcenter/getabout.php?groupid=" + groupid + "&" + hostArr);
                            getabout_xhr = $.ajax({
                              url: "ajax/vcenter/getabout.php?groupid=" + groupid + hostArr + timerange, 
                              success: function(result) {
                ...
                <div class="row" id="vcenter-cluster">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        ...
                        <div id="getcluster"></div>        
                          <script>
                            ...
                            function loadCluster() {      
                              //console.log("load");           
                              // $("#getuptime").load("ajax/vcenter/getuptime.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              getuptime_xhr = $.ajax({
                                url: "ajax/vcenter/getcluster.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                                  $("#getcluster").html(result);
                                },
                                complete: function() {
                                  if (diff <= 604800 && timetill == "") {
                                    // var problems_table = setTimeout(loadProblemsTable, 60000);
                ...
                <div class="row" id="vcenter-freedisk">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                      ...
                      <div class="box-body">
                        ...
                        <script>
                          ...
                          function loadFreeDiskSpace() { 
                            // $("#getdisk").load("ajax/vcenter/getdisk.php?groupid=" + groupid + "&" + hostArr + timerange);
                            getdisk_xhr = $.ajax({
                              url: "ajax/vcenter/getdisk.php?groupid=" + groupid + hostArr + timerange, 
                              success: function(result) {
                                $("#getdisk").html(result);
                              },
                              complete: function() {
                ...
                <div class="row" id="vcenter-readlatencygraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        <h3 class="box-title">Average read latency to the disk</h3>
                        <div class="box-tools pull-right">
                          <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                        </div>
                      </div>
                        ...
                        <div id="read_latency"></div>        
                          <script>
                            ...
                            function loadReadLatency() {      
                              //console.log("load");           
                              // $("#read_latency").load("ajax/vcenter/read_latency.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              read_latency_xhr = $.ajax({
                                url: "ajax/vcenter/read_latency.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
                ...
                <div class="row" id="vcenter-writelatencygraph">
                  <div class="col-md-12">
                    <div class="box box-solid box-default">
                      <div class="box-header">
                        <h3 class="box-title">Average write latency to the disk </h3>
                        <div class="box-tools pull-right">
                          <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                        </div>
                      </div>
                        ...
                        <div id="write_latency"></div>        
                          <script>
                            ...
                            function loadWriteLatency() {      
                              //console.log("load");           
                              // $("#write_latency").load("ajax/vcenter/write_latency.php?groupid=" + groupid + "&" + hostArr + timerange);     
                              write_latency_xhr = $.ajax({
                                url: "ajax/vcenter/write_latency.php?groupid=" + groupid + hostArr + timerange, 
                                success: function(result) {
