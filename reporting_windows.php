                              ...
                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                ...
                                foreach ($result as $row) {
                                  if ($row["name"] != $groupname && $row["name"] != "Windows Event Log") {
                                    ...
                                    print "<option value='reporting_windows.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                  }
                                }
                                ?>
                              </select>
      ...
      <section class="invoice" id="reportdiv">
        ...
        <div class="row" id="report-title">
          <div class="col-xs-12">
            <h2 class="page-header">
              <i class="fa fa-globe"></i> Windows Overview - Report
        ...
        <div class="row" id="report-info">
          ...
          <div class="col-xs-12 table-responsive">
            ...
            <div id="getabout"></div>
            <script>
              $("#getabout").load("reporting/windows/getabout.php?groupid=" + groupid + "&" + hostArr, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Info: ";
        ...
        <div class="row" id="report-uptime">
          <div class="col-xs-12 table-responsive">
            ...
            <div id="uptime"></div>
            <script>
              $("#uptime").load("reporting/windows/uptime.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Uptime: ";
        ...
        <div class="row" id="report-freedisk">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Free Disk Space (%)</p>
            <div id="diskspace"></div>
            <script>
              $("#diskspace").load("reporting/windows/diskspace.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Free Disk Space (Percentage): ";
                  $("#diskspace").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
                  ...
                  html2canvas(document.getElementById('report-freedisk')).then(function(canvas) {
                    var img = canvas.toDataURL();
                    tablepng[4] = img;
                  })
                }
        ...
        <div class="row" id="report-forecastmem">
          <div class="col-xs-12 table-responsive">
            <p class="lead">Forecast</p>
            <div id="forecast_memory"></div>
            <script>
              $("#forecast_memory").load("reporting/windows/forecast_memory.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Forecast Used Memory (%): ";
        ...
        <div class="row" id="report-forecastdisk">
          <div class="col-xs-12 table-responsive">
            ...
            <script>
              $("#forecast_disk").load("reporting/windows/forecast_disk.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Forecast Free Disk Space: ";
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="cpuutil"></div>
            <script>
              $("#cpuutil").load("reporting/windows/cpuutil.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="usedmem"></div>
            <script>
              $("#usedmem").load("reporting/windows/usedmem.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Used Memory (%): ";
                  $("#cpuutil").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="numprocesses"></div>
            <script>
              $("#numprocesses").load("reporting/windows/numprocesses.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Number or Processes: ";
                  $("#numprocesses").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            ...
            <script>
              $("#filewrite").load("reporting/windows/filewrite.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "File write bytes per second: ";
                  $("#filewrite").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="fileread"></div>
            <script>
              $("#fileread").load("reporting/windows/fileread.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "File read bytes per second: ";
                  $("#fileread").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            <div id="diskspace_graph"></div>
            <script>
              $("#diskspace_graph").load("reporting/windows/diskspace_graph.php?groupid=" + groupid + hostArr + timerange, function(response, status, xhr) {
                if (status == "error") {
                  var msg = "Free Disk Space (%): ";
                  $("#diskspace_graph").html(msg + xhr.status + " " + xhr.statusText);
                  countcheck = countcheck + 1;
