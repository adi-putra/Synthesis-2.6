        ...
        <div class="row">
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="linux-problems" checked><a href="#linux-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="linux-about" checked><a href="#linux-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="linux-uptime" checked><a href="#linux-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="cpu-util" checked><a href="#cpu-util">CPU Utilization</a></li>
                    <li><input type="checkbox" class="sub-box" value="used-mem" checked><a href="#used-mem">Memory Utilization</a></li>
                    <li><input type="checkbox" class="sub-box" value="swap-space" checked><a href="#swap-space">Free Swap Space</a></li>
                    <li><input type="checkbox" class="sub-box" value="cpu-util-graph" checked><a href="#cpu-util-graph">CPU Utilization Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="used-mem-graph" checked><a href="#used-mem-graph">Memory Utilization Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="swap-space-graph" checked><a href="#swap-space-graph">Free Swap Space Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="process-graph" checked><a href="#process-graph">Running Processes Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="bits-sent-graph" checked><a href="#bits-sent-graph">Bits Sent Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="bits-rec-graph" checked><a href="#bits-rec-graph">Bits Received Graph</a></li>
                    <li><input type="checkbox" class="sub-box" value="space-util" checked><a href="#space-util">Space Utilization</a></li>
                    <li><input type="checkbox" class="sub-box" value="forecast-mem" checked><a href="#forecast-mem">Forecast Memory</a></li>
                    <li><input type="checkbox" class="sub-box" value="forecast-disk" checked><a href="#forecast-disk">Forecast Disk</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                <div class="box-body">
                  <div class="row" id="linux-problems">
                    <div class="col-md-12">
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            ...
                            function loadAbout() {      
                              //console.log("load");           
                              $("#loadabout").load("ajax/linux/getabout.php?groupid=" + groupid + hostArr);    
                            }
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadUptime();
                            if (diff <= 604800 && timetill == "") {
                              var loaduptime = setInterval(loadUptime, 300000);
                            }
                            
                            function loadUptime() {      
                              //console.log("load");           
                              $("#loaduptime").load("ajax/linux/getuptime.php?" + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="cpu-util">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="loadcpuutil"></div>
                          <script>
                            loadCPUUtil();
                            if (diff <= 604800 && timetill == "") {
                              var loadcpuutil = setInterval(loadCPUUtil, 300000);
                            }
                            
                            function loadCPUUtil() {      
                              //console.log("load");           
                              $("#loadcpuutil").load("ajax/linux/getcpuutil.php?" + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="used-mem">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Memory Utilization (%)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getusedmem"></div>
                          <script>
                            loadUsedMem();
                            if (diff <= 604800 && timetill == "") {
                              var getusedmem = setInterval(loadUsedMem, 300000);
                            }
                            
                            function loadUsedMem() {      
                              //console.log("load");           
                              $("#getusedmem").load("ajax/linux/getusedmem.php?" + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="swap-space">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Free Swap Space (%)</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadswapmem"></div>
                          <script>
                            loadSwapMem();
                            if (diff <= 604800 && timetill == "") {
                              var loadswapmem = setInterval(loadSwapMem, 300000);
                            }
                            
                            function loadSwapMem() {      
                              //console.log("load");           
                              $("#loadswapmem").load("ajax/linux/getswapmem.php?" + hostArr);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="cpu-util-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="loadcpuutilchart"></div>
                          <script>
                            loadCPUUtilGraph();
                            if (diff <= 604800 && timetill == "") {
                              var loadcpuutilchart = setInterval(loadCPUUtilGraph, 300000);
                            }
                            
                            function loadCPUUtilGraph() {     
                              //console.log("load");           
                              $("#loadcpuutilchart").load("ajax/linux/get_cpu_util_graph.php?" + hostArr + timerange);     
                            }            
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="used-mem-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getusedmemgraph"></div>
                          <script>
                            loadUsedMemGraph();
                            if (diff <= 604800 && timetill == "") {
                              var getusedmemgraph = setInterval(loadUsedMemGraph, 300000);
                            }
                            
                            function loadUsedMemGraph() {      
                              //console.log("load");           
                              $("#getusedmemgraph").load("ajax/linux/getusedmemgraph.php?" + hostArr + timerange);     
                            }           
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="swap-space-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Free Swap Space in % Graph</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadswapmemchart"></div>
                          <script>
                            loadSwapMemGraph();
                            if (diff <= 604800 && timetill == "") {
                              var loadswapmemchart = setInterval(loadSwapMemGraph, 300000);
                            }
                            
                            function loadSwapMemGraph() {      
                              //console.log("load");           
                              $("#loadswapmemchart").load("ajax/linux/get_swap_mem_graph.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadProcessGraph();
                            if (diff <= 604800 && timetill == "") {
                              var loadprochart = setInterval(loadProcessGraph, 300000);
                            }
                            
                            function loadProcessGraph() {      
                              //console.log("load");           
                              $("#loadprochart").load("ajax/linux/getprocessgraph.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="bits-sent-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadBitsSentGraph();
                            if (diff <= 604800 && timetill == "") {
                              var bits_sent = setInterval(loadBitsSentGraph, 300000);
                            }
                            
                            function loadBitsSentGraph() {      
                              //console.log("load");           
                              $("#bits_sent").load("ajax/linux/bits_sent.php?" + hostArr + timerange);     
                            }           
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="bits-rec-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadBitsRecGraph();
                            if (diff <= 604800 && timetill == "") {
                              var bits_received = setInterval(loadBitsRecGraph, 300000);
                            }
                            
                            function loadBitsRecGraph() {      
                              //console.log("load");           
                              $("#bits_received").load("ajax/linux/bits_received.php?" + hostArr + timerange);     
                            }           
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="space-util">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="getspaceutil"></div>
                          <script>
                            loadSpaceUtil();
                            if (diff <= 604800 && timetill == "") {
                              var getspaceutil = setInterval(loadSpaceUtil, 300000);
                            }
                            
                            function loadSpaceUtil() {      
                              //console.log("load");           
                              $("#getspaceutil").load("ajax/linux/getspaceutil.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="forecast-mem">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Forecast Memory</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="get_forecastmem"></div>
                          <script>
                            loadForecastMem();
                            if (diff <= 604800 && timetill == "") {
                              var get_forecastmem = setInterval(loadForecastMem, 300000);
                            }
                            
                            function loadForecastMem() {      
                              //console.log("load");           
                              $("#get_forecastmem").load("ajax/linux/get_forecastmem.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="forecast-disk">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="get_forecastdisk"></div>
                          <script>
                            loadForecastDisk();
                            if (diff <= 604800 && timetill == "") {
                              var get_forecastdisk = setInterval(loadForecastDisk, 300000);
                            }
                            
                            function loadForecastDisk() {      
                              //console.log("load");           
                              $("#get_forecastdisk").load("ajax/linux/get_forecastdisk.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
