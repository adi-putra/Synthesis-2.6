    ...
    <tbody>
      <?php
        ...
        foreach ($result as $item) {
          ...
          print "<td>$fanName</td>";
          if ($fanStatus == "Normal") {
            print "<td><button class='btn btn-block btn-success btn-sm'>$fanStatus</button></td></tr>";
          }
          else {
            print "<td><button class='btn btn-block btn-danger btn-sm'>$fanStatus</button></td></tr>";
          }
          $id++;
        }  
      ?>
