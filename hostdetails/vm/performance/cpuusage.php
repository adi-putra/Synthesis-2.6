...
foreach ($result as $host) {
    ...
    "hostids" => $hostid,
    "search" => array("name" => "VMware: CPU usage"), //seach id contains specific word
    );
    //call api method
...
cpuutil_chart.numberFormatter.numberFormat = "# Mhz";
// cpuutil_chart.numberFormatter.bigNumberPrefixes = [
