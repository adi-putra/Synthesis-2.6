...
foreach (array_reverse($result) as $object) {
    $problemName = str_replace("Zabbix","Synthesis",$object["name"]);
    ...
    <body>  
            ...
            <script>
                function selectLimit() {
                    ...
                    $("#timeline_chart").load("/synthesis/problems/timeline_chart.php?objectid=" + objectid + "&hostid=" + hostid + "&limit=" + limit);
                }
            </script>
