...
<body>
  ...
  $memSeries = '';
    ...
    foreach ($result as $host) {
      ...
      $params = array(
        ...
        "hostids" => $hostid,
        "search" => array("name" => array("RAM Usage","Memory util")), //seach id contains specific word
        "searchByAny" => true
      );
      //call api method
  ...
  <script>
    ...
    memchart.numberFormatter.numberFormat = "# '%'";

    var title = memchart.titles.create();
    title.text = "RAM Utilization (%)";
    title.fontSize = 25;
