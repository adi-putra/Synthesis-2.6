...
cpuusertime_chart.legend.scrollable = true;
...
cpuusertime_chart.exporting.adapter.add("data", function(data, target) {
    // Assemble data from series
    var data = [];
    cpuusertime_chart.series.each(function(series) {
...
graphpng[0] = cpuusertime_chart.exporting.pdfmake;
graphpng[1] = cpuusertime_chart.exporting.getImage("png");
</script>