    ...
    <table id="agg_state" class="table table-bordered table-striped">
      ...
      <?php
        ...
        foreach ($Aggregate as $row) {
          ...
          if (strpos($name, 'Aggregate State') !== false) {


            $name = substr($name, -23, 22); // returns 'd'

            if($value == 'online'){

              print "<tr>";
              print "<td>".$name."</td>";
              print "<td><button type='button' class='btn btn-success'>".$value."</td>";
              print "</tr>";
              ...
              print "<tr>";
              print "<td>".$name."</td>";
              print "<td><button type='button' class='btn btn-danger'>".$value."</td>";
              print "</tr>";
            }
