...
<body>
      ...
      $result = $zbx->call('item.get', $params);
      foreach ($result as $item) {
        $outputVolt = $item["lastvalue"];
      }

      print "<i class='fa fa-arrow-circle-down' style='color: green;'></i> $inputVolt V
              <i class='fa fa-arrow-circle-up' style='color: red;'></i> $outputVolt V";
      ?>
</body>
