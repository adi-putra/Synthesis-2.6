...
<body>
      ...
      $result = $zbx->call('item.get', $params);
      foreach ($result as $item) {
        $outputFreq = $item["lastvalue"];
      }

      
      print "<i class='fa fa-arrow-circle-down' style='color: green;'></i> $inputFreq Hz
              <i class='fa fa-arrow-circle-up' style='color: red;'></i> $outputFreq Hz";
      ?>
</body>
