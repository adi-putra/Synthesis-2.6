...
<body class="skin-blue">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      $history_link = "history.php?" . $groupArr . $hostArr . $timerange;

      //link for problems page
      $closedprob_link = "closedprob.php?" . $groupArr . $hostArr . $timerange;
      ?>
                ...
                <div class="tab-pane active" id="tab_2-2">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <a href='problems.php?&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>'><button class="btn btn-default margin">Reset</button></a>
                    </div>
                  </div>
                </div><!-- /.tab-pane -->
              </div><!-- /.tab-content -->
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                      <ul class="nav nav-tabs">
                        ...
                        <li><a href='<?php echo $closedprob_link; ?>'>Closed Problems (User)</a></li>
                      </ul>
                      <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                          ...
                          <script>
                            ...
                            function loadProblemsTable() {
                              ...
                              $("#problems").load("problems/problem_table.php?" + groupid + hostid + timerange, function(response, status, xhr) {
                                if (status == "error") {
                                  var msg = "Info: ";
                                  $("#problems").html(msg + xhr.status + " " + xhr.statusText);
                                }
                              });
                            }
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form id="groupForm">
                      <!-- <p><i>To select "All", click "Apply" without checking on the checkboxes</i></p> -->
