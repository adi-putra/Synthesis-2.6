              ...
              if ($row["name"] != $hostname) {
                ...
                foreach ($row["groups"] as $group) {
                  ...
                  if (stripos($getgroupname, "sql")) {
                    print "<option value='application_sql_issues.php?hostid=" . $gethostid . "'>$gethostname</option>";
                  }
                }
              } else {
                continue;
      ...
      <div class="content row">
        ...
        <div class="nav-tabs-custom mytabs">
          <ul class="nav nav-tabs">
            <li id="tab_1li" class="<?php if (isset($_GET['timefrom'])) { echo ""; } else { echo "active"; } ?>"><a data-target="#tab_1" data-toggle="tab">Latest</a></li>
            <li id="tab_2li" class="tab-pane <?php if (isset($_GET['timefrom'])) { echo "active"; } else { echo ""; } ?>"><a data-target="#tab_2" data-toggle="tab">History</a></li>
          </ul>

          <div class="tab-content">
            <div class="tab-pane <?php if (isset($_GET['timefrom'])) { echo ""; } else { echo "active"; } ?>" id="tab_1">
              <!-- Cards -->
              <div class="row">
            ...
            <div class="tab-pane <?php if (isset($_GET['timefrom'])) { echo "active"; } else { echo ""; } ?>" id="tab_2">
              <section class="applicationsql">
                <div class="row">
                  <div class="col-xs-12">
                      ...
                      <div class="box-body">
                        <div class="col-sm-12">
                          <div class="box" style="background-color: #3c8dbc;">
                            ...
                            <div class="box-body">
                              <form action="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                                      <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                          <li><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                          <li><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 hour</a></li>
                                          <li><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 day</a></li>
                                          <li><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 2 days</a></li>
                                          <li><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 7 days</a></li>
                                          <li><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 month</a></li>
                        ...
                        <div class="row" id="mycontent-host">
                          <div class="col-xs-12">
                                ...
                                <div class="box-body show">
                                  <ul class="nav nav-pills nav-stacked application-nav">
                                    ...
                                    <ul class="nav nav-tabs nav-stacked">
                                      <li class="active"><a href="application_sql_issues.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">Issues</a></li>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                              <!-- Issues -->
                    <div id="issues" style="padding-bottom: 50px;">
                      <h3>Issues</h3>
                      <!-- SEVERITY INFO TABLE -->
                      <div class="row">
                          <div class="col-md-12">
                      ...
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          ...
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" onclick="loadProblemsTable()" data-toggle="tooltip" title="Refresh"><i class="fa fa-refresh"></i></button>
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                  <li class="active"><a data-target="#problems_1" onclick="loadProblemsTable()" data-toggle="tab">Unresolved Problems</a></li>
                                  <li><a data-target="#problems_2"  onclick="loadHistoryTable()" data-toggle="tab">Resolved Problems</a></li>
                                  <li><a data-target="#problems_3"  onclick="loadClosedTable()" data-toggle="tab">Closed Problems</a></li>
                                </ul>
                                <div class="tab-content">
                                  <div class="tab-pane active" id="problems_1">
                                  <div id="problems"></div>
                                    <script>
                                      ...
                                      function loadProblemsTable() {
                                        ...
                                        //$("#problem_ack_info").load("hostdetails/issues/problem_ack_info.php?hostid=" + hostid);
                                        $("#problem_sev_info").load("problems/problem_sev_info.php?hostid[]=" + hostid);
                                      }
                                  ...
                                  <div class="tab-pane" id="problems_2">
                                  <div id="historyproblems"></div>
                                  <script>
                                      //begin page by start the interval
                                      loadHistoryTable();
                                      var history_table = setInterval(loadHistoryTable, 60000);

                                      //ajax call to load content                                                                      
                                      function loadHistoryTable() {
                                        $("#historyproblems").load("hostdetails/issues/history_table.php?hostid=" + hostid + timerange);
                                      }
                                    </script>
                                  </div><!-- /.tab-pane -->
                                  <div class="tab-pane" id="problems_3">
                                    <div id="closedprob"></div>
                                    <script>
                                      //begin page by start the interval
                                      loadClosedTable();
                                      ...
                                      function loadClosedTable() {
                                        $("#closedprob").load("hostdetails/issues/closedprob_table.php?hostid=" + hostid + timerange);
                                      }
                              ...
                              <div class="box box-solid box-default" id="winsyslog">
                                <div class="box-header">
                                  <h3 class="box-title">Windows System Log (last 50)</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class="box-body">
                                  <div id="window_syslog"></div>
                                  <script>
                                    $("#window_syslog").load("application/sql/issues/window_syslog.php?hostid=" + hostid + timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="winapplog">
                                <div class="box-header">
                                  <h3 class="box-title">Windows Application Log (last 50)</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class="box-body">
                                  <div id="window_applog"></div>
                                  <script>
                                    $("#window_applog").load("application/sql/issues/window_applog.php?hostid=" + hostid + timerange);
                                  </script>
                                </div>
                              </div>

                              <div class="box box-solid box-default" id="jobfailed">
                                <div class="box-header">
                                  <h3 class="box-title">Job Failed</h3>
                                  <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                  </div>
                                </div>
                                <div class="box-body">
                                  ...
                                  <div id="fail_job"></div>
                                  <script>
                                    $("#fail_job").load("application/sql/issues/fail_job.php?hostid=" + hostid + timerange);
                                  </script>

                                </div>
                              </div>

                              <div class="box box-solid box-default" id="sqlbackup">
                                <div class="box-header">
                                ...
                                <div class="box-body">
                                  ...
                                  <div id="backup_job"></div>
                                  <script>
                                    $("#backup_job").load("application/sql/issues/sql_backup_fail.php?hostid=" + hostid + timerange);
                                  </script>
                                </div>
                              </div>
                            </div>
