...
<body class="skin-blue">
  <div class="wrapper" style="background-color: white;">
      ...
      <section class="content-header">
        <h1>
          Report - Problems Acknowledgement
          <small></small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">Acknowledges</li>
        </ol>
      </section>
                    ...
                    <div class="tab-pane active" id="tab_2-2">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href='report_acknowledges.php?&timefrom=<?php echo $timefrom;?>&timetill=<?php echo $timetill;?>'><button class="btn btn-default margin">Reset</button></a>
                            </div>
                        </div>
                    </div><!-- /.tab-pane -->
                    </div><!-- /.tab-content -->
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <script>
                                    ...
                                    loadReportAcknowledges();

                                    //ajax call to load content                                                                      
                                    function loadReportAcknowledges() {
                                        $("#report_acknowledges").load("report/report_ack_data.php?" + groupid + hostid + timerange, function( response, status, xhr ) {
                                          if ( status == "error" ) {
                                            var msg = "Info: ";
                                            $( "#report_acknowledges" ).html( msg + xhr.status + " " + xhr.statusText );
                                          }
                                        });
                                    }

                                    //if click button acknowledge problem, stop interval
                                    function stopIntReportAcknowledges() {
                                        console.log("stop prob int");
                                        //clearInterval(report_problems);
                                    }

                                    //if done or close the ack form, start interval back
                                    function startIntReportAcknowledges() {
                                        console.log("start prob int");
                                        //refresh problem table after 1 sec
                                        setTimeout(loadReportAcknowledges, 1000);
