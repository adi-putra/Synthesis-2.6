  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Problems - Resolved Problems (System)
          <small></small>
        </h1>
        <ol class="breadcrumb">
      ...
      <?php
        ...
        $problem_link = "problems.php?".$groupArr.$hostArr.$prob_timerange;

        //link for closed prob page
        $closedprob_link = "closedprob.php?".$groupArr.$hostArr.$prob_timerange;
      ?>
                    ...
                    <div class="tab-pane active" id="tab_2-2">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href='history.php?&timefrom=<?php echo $timefrom;?>&timetill=<?php echo $timetill;?>'><button class="btn btn-default margin">Reset</button></a>
                            </div>
                        </div>
                    </div><!-- /.tab-pane -->
                    </div><!-- /.tab-content -->
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <li><a href='<?php echo $problem_link;?>'>Unresolved Problems</a></li>
                            <li class="active"><a href="#tab_2" data-toggle="tab">Resolved Problems (System)</a></li>
                            ...
                            <div class="tab-pane active" id="tab_2">
                                ...
                                <script>
                                    ...
                                    function loadHistoryTable() {
                                      $("#historyproblems").load("problems/history_table.php?" + groupid + hostid + timerange, function( response, status, xhr ) {
                                        if ( status == "error" ) {
                                          var msg = "Info: ";
                                          $( "#historyproblems" ).html( msg + xhr.status + " " + xhr.statusText );
                                        }
                                      });
                                    }         
                                </script>
