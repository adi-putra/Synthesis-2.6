...
$fixedprompt = "Act as expert problem Solver, Explain what is this problem, what are the root cause and what are the possible way to solve it with up to date URL for reference in  a bullet format if the url not valid or not found related to the prompt or problems,  dont show it.";
?>
    ...
    this._parseEventChunk = function(chunk) {
        ...
        chunk.split(/\n|\r\n|\r/).forEach(
            function(line) {
                ...
                // var value = line.replace("Zabbix", "Synthesis").substring(index + 2).trimLeft();
                var value = line.replace("Zabbix", "Synthesis").substring(index + 2).trimLeft();
...
if(prompt != ''){
    ...
    var source = new SSE("/synthesis/dashboard/problems/request.php?prompt=" + fixedprompt + prompt);
