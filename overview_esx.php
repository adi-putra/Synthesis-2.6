  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        $formlink = "overview_esx.php?" . $hostArr;

        $timerange = "&timefrom=" . $timefrom . "&timetill=" . $timetill;
        ?>

        <!--<form action="overview_esx.php?<?php echo $hostArr; ?>timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">-->
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                foreach ($result as $row) {
                                                  ...
                                                  print "<option value='overview_esx.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="esx-problems" checked><a href="#esx-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="esx-about" checked><a href="#esx-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="virtual-machines" checked><a href="#virtual-machines">Virtual Machines</a></li>
                    <li><input type="checkbox" class="sub-box" value="cpu-util" checked><a href="#cpu-util">Current CPU Utilization</a></li>
                    <li><input type="checkbox" class="sub-box" value="use-mem" checked><a href="#use-mem">Current Used Memory</a></li>
                    <li><input type="checkbox" class="sub-box" value="use-esximem" checked><a href="#use-esximem">Current Used ESXI Memory</a></li>
                    ...
                    <li><input type="checkbox" class="sub-box" value="useesximem-graph" checked><a href="#useesximem-graph">Used ESXI Memory</a></li>
                    <li><input type="checkbox" class="sub-box" value="process-graph" checked><a href="#process-graph">Running Processes</a></li>
                    <li><input type="checkbox" class="sub-box" value="ballooned-graph" checked><a href="#ballooned-graph">Ballooned Memory</a></li>
                    <li><input type="checkbox" class="sub-box" value="disk-graph" checked><a href="#disk-graph">Free Disk Space</a></li>
                    <li><input type="checkbox" class="sub-box" value="net-traffic" checked><a href="#net-traffic">Network Traffic</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            $("#loadabout").load("ajax/esx/getabout.php?groupid=" + groupid + "&" + hostArr);
                          </script>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" id="virtual-machines">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="virtual_machines"></div>        
                            <script>
                              loadVirtualMachines();
                              if (diff <= 604800 && timetill == "") {
                                var virtual_machines = setInterval(loadVirtualMachines, 60000);
                              }
                              function loadVirtualMachines() {      
                                //console.log("load");           
                                $("#virtual_machines").load("ajax/esx/virtual_machines.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="cpu-util">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="getcpuload1"></div>        
                            <script>
                              loadCPU();
                              if (diff <= 604800 && timetill == "") {
                                var getcpuload1 = setInterval(loadCPU, 60000);
                              }
                              function loadCPU() {      
                                //console.log("load");           
                                $("#getcpuload1").load("ajax/esx/getcpuload1.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="use-mem">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Current Used Memory</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                            <div id="load_usedmem"></div>        
                            <script>
                              loadUsedMem();
                              if (diff <= 604800 && timetill == "") {
                                var load_usedmem = setInterval(loadUsedMem, 60000);
                              }
                              function loadUsedMem() {      
                                //console.log("load");           
                                $("#load_usedmem").load("ajax/esx/getusedmem.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="use-esximem">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Current Used ESXI Memory</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                            <div id="load_esxiusedmem"></div>        
                            <script>
                              loadUsedESXIMem();
                              if (diff <= 604800 && timetill == "") {
                                var load_esxiusedmem = setInterval(loadUsedESXIMem, 60000);
                              }
                              function loadUsedESXIMem() {      
                                //console.log("load");           
                                $("#load_esxiusedmem").load("ajax/esx/getusedesximem.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                        ...
                        <div class="box-body">
                          <div id="getcpugraph"></div>        
                            <script>
                              loadCPUGraph();
                              if (diff <= 604800 && timetill == "") {
                                var getcpugraph = setInterval(loadCPUGraph, 60000);
                              }
                              function loadCPUGraph() {      
                                //console.log("load");           
                                $("#getcpugraph").load("ajax/esx/getcpugraph.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                        ...
                        <div class="box-body">
                          <div id="getmemgraph"></div>        
                            <script>
                              loadUsedMemGraph();
                              if (diff <= 604800 && timetill == "") {
                                var getmemgraph = setInterval(loadUsedMemGraph, 60000);
                              }
                              function loadUsedMemGraph() {      
                                //console.log("load");           
                                $("#getmemgraph").load("ajax/esx/getmemgraph.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="useesximem-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Used ESXI Memory Graph</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="usedesximem_graph"></div>        
                            <script>
                              loadUsedESXIMemGraph();
                              if (diff <= 604800 && timetill == "") {
                                var usedesximem_graph = setInterval(loadUsedESXIMemGraph, 60000);
                              }
                              function loadUsedESXIMemGraph() {      
                                //console.log("load");           
                                $("#usedesximem_graph").load("ajax/esx/usedesximem_graph.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="process-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="getprocessgraph"></div>        
                            <script>
                              loadProcessGraph();
                              if (diff <= 604800 && timetill == "") {
                                var getprocessgraph = setInterval(loadProcessGraph, 60000);
                              }
                              function loadProcessGraph() {      
                                //console.log("load");           
                                $("#getprocessgraph").load("ajax/esx/getprocessgraph.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="ballooned-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Ballooned Memory Graph</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="getballoonedgraph"></div>        
                            <script>
                              loadBalloonedGraph();
                              if (diff <= 604800 && timetill == "") {
                                var getballoonedgraph = setInterval(loadBalloonedGraph, 60000);
                              }
                              function loadBalloonedGraph() {      
                                //console.log("load");           
                                $("#getballoonedgraph").load("ajax/esx/getballoonedgraph.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="disk-graph">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Free Disk Space Percentile</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          ...
                          <script>
                            ...
                            $("#loaddisk").load("ajax/esx/getdisk.php?" + hostArr + timerange);
                  ...
                  <div class="row" id="net-traffic">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="getnettraffic"></div>        
                            <script>
                              loadNettraffic();
                              if (diff <= 604800 && timetill == "") {
                                var getnettraffic = setInterval(loadNettraffic, 60000);
                              }
                              function loadNettraffic() {      
                                //console.log("load");           
                                $("#getnettraffic").load("ajax/esx/getnettraffic.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
