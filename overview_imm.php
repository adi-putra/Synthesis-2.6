                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                $params = array(
                                                  ...
                                                  print "<option value='overview_imm.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <div class="row" id="mycontent">
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="imm-problems" checked><a href="#imm-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="imm-about" checked><a href="#imm-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="imm-uptime" checked><a href="#imm-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="imm-powersupply" checked><a href="#imm-powersupply">Power Supply</a></li>
                    <li><input type="checkbox" class="sub-box" value="imm-physicaldisks" checked><a href="#imm-physicaldisks">Physical Disks</a></li>
                    <li><input type="checkbox" class="sub-box" value="imm-fans" checked><a href="#imm-fans">Fans</a></li>
                    <li><input type="checkbox" class="sub-box" value="imm-temperatures" checked><a href="#imm-temperatures">Temperatures</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                    ...
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            $("#loadabout").load("ajax/imm/getabout.php?groupid=" + groupid + "&" + hostArr);
                          </script>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="box-body">
                          <div id="getuptime"></div>        
                            <script>
                              ...
                              function loadUptime() {      
                                //console.log("load");           
                                $("#getuptime").load("ajax/imm/getuptime.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="imm-powersupply">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          ...
                          <div id="power_supply"></div>        
                            <script>
                              ...
                              function loadPowerSupply() {      
                                //console.log("load");           
                                $("#power_supply").load("ajax/imm/power_supply.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="imm-physicaldisks">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          ...
                          <div id="physical_disks"></div>        
                            <script>
                              ...
                              function loadPhysicalDisk() {      
                                //console.log("load");           
                                $("#physical_disks").load("ajax/imm/physical_disks.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                        ...
                        <div class="box-body">
                          <div id="fans"></div>        
                            <script>
                              ...
                              function loadFans() {      
                                //console.log("load");           
                                $("#fans").load("ajax/imm/fans.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="imm-temperatures">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          ...
                          <div id="temperatures"></div>        
                            <script>
                              ...
                              function loadTemperatures() {      
                                //console.log("load");           
                                $("#temperatures").load("ajax/imm/temperatures.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
