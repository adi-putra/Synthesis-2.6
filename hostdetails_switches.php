  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="form-group">
          <select class="form-control" name="selecthost" onchange="location = this.value;" style="display: inline-block; width: auto;">
            ...
            foreach ($result as $row) {
              ...
              if (stripos($gethostname, "switch") !== false or stripos($gethostname, "Switch") !== false or stripos($getgroupname, "switch") !== false or stripos($getgroupname, "Switch") !== false) {
                print "<option value='hostdetails_switches.php?hostid=" . $gethostid . "'>$gethostname</option>";
              } 
            }
            ?>
          </select>
      ...
      function loadAllGraph(timefrom, timetill) {
        ...
        loadBitsSent(hostid, timerange);
        loadBitsRec(hostid, timerange);
        loadInboundDisc(hostid, timerange);
        loadOutboundDisc(hostid, timerange);
        loadInboundError(hostid, timerange);
        loadOutboundError(hostid, timerange);
      ...
      function loadCPUPercGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#cpu_percentage").load("hostdetails/switches/performance/cpu_percentage.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadUsedMemGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#used_memory").load("hostdetails/switches/performance/used_memory.php?hostid=" + hostid + timerange);
          }, 60000);
      ...
      function loadBitsSent(hostid, timerange) {
        var interval = setInterval(function() {
          ...
          timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
          $("#bits_sent").load("hostdetails/switches/performance/bits_sent.php?hostid=" + hostid + timerange);
        }, 60000);
      ...
      function loadBitsRec(hostid, timerange) {
        var interval = setInterval(function() {
          timefrom = '<?php echo $timefrom; ?>';
          if (timetill == currTime) {
            timetill = Math.floor(Date.now() / 1000);
          ...
          timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
          $("#bits_received").load("hostdetails/switches/performance/bits_received.php?hostid=" + hostid + timerange);
        }, 60000);
      ...
      function loadInboundDisc(hostid, timerange) {
        var interval = setInterval(function() {
          ...
          timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
          $("#inbound_discarded").load("hostdetails/switches/performance/inbound_discarded.php?hostid=" + hostid + timerange);
        }, 60000);
      ...
      function loadOutboundDisc(hostid, timerange) {
        var interval = setInterval(function() {
          ...
          timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
          $("#outbound_discarded").load("hostdetails/switches/performance/outbound_discarded.php?hostid=" + hostid + timerange);
        }, 60000);
      ...
      function loadInboundError(hostid, timerange) {
        var interval = setInterval(function() {
          timefrom = '<?php echo $timefrom; ?>';
          if (timetill == currTime) {
            timetill = Math.floor(Date.now() / 1000);
          ...
          timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
          $("#inbound_errors").load("hostdetails/switches/performance/inbound_errors.php?hostid=" + hostid + timerange);
        }, 60000);
      ...
      function loadOutboundError(hostid, timerange) {
        var interval = setInterval(function() {
          timefrom = '<?php echo $timefrom; ?>';
          if (timetill == currTime) {
            timetill = Math.floor(Date.now() / 1000);
          ...
          timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
          $("#outbound_errors").load("hostdetails/switches/performance/outbound_errors.php?hostid=" + hostid + timerange);
        }, 60000);
        ...
        <div class="row">
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentCPU() {
                      $("#current_cpu").load("hostdetails/switches/cards/current_cpu.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentMem() {
                      $("#current_memory").load("hostdetails/switches/cards/current_memory.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <h3>
                  <div id="total_interfaces"></div>
                  <script>
                    loadTotalInt();
                    var total_interfaces = setInterval(loadTotalInt, 60000);

                    function loadTotalInt() {
                      $("#total_interfaces").load("hostdetails/switches/cards/total_interfaces.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
              ...
              <a href="#interfaces" class="small-box-footer">
                More info <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div><!-- ./col -->
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProblems() {
                      $("#today_problems").load("hostdetails/switches/cards/today_problems.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
              ...
              <div class="box-body">
                ...
                <div class="col-sm-12">
                  <div class="box" style="background-color: #3c8dbc;">
                    ...
                    <div class="box-body">
                      <form action="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                        <div class="row">
                          <div class="col-lg-4 col-md-4 col-sm-12 text-center" style="padding-bottom: 15px;">
                            <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                              <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                ...
                                <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 hour</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 day</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 2 days</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 7 days</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 month</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-3 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 3 months</a></li>
                                  <li><a href="hostdetails_switches.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-6 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 6 months</a></li>
                                </ul>
                              </div>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                      ...
                      <div id="systeminfo" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="sysinfo"></div>
                            <script>
                              $("#sysinfo").load("hostdetails/switches/system_info/systeminfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="status"></div>
                            <script>
                              $("#status").load("hostdetails/switches/system_info/status.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="general"></div>
                            <script>
                              $("#general").load("hostdetails/switches/system_info/general.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#sysuptime").load("hostdetails/switches/system_info/sysuptime.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#interfaces").load("hostdetails/switches/system_info/interfaces.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                      ...
                      <div id="performance" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Used Memory</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Bits Sent</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Bits Received</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Inbound Packets Discarded</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            <div id='inbound_discarded'></div>
                            <script>
                              loadInboundDisc(hostid, timerange);
                            </script>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Outbound Packets Discarded</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            <div id='outbound_discarded'></div>
                            <script>
                              loadOutboundDisc(hostid, timerange);
                            </script>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Inbound Packets with Errors</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            <div id='inbound_errors'></div>
                            <script>
                              loadInboundError(hostid, timerange);
                            </script>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Outbound Packets with Errors</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            <div id='outbound_errors'></div>
                            <script>
                              loadOutboundError(hostid, timerange);
                            </script>
                          </div>
