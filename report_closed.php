...
<body class="skin-blue">
  <div class="wrapper" style="background-color: white;">
        <header class="main-header">
            <!-- Logo -->
            <a href="dashboard.php" class="logo"><img src="dist/img/Synthesis-Trans-long.png" alt="Synthesis Logo" width="auto" height="auto"></a>
      ...
      <?php
        ...
        $timerange = "&timefrom=".strtotime("today")."&timetill=".strtotime("now");

        //link for report problems page
        $rproblem_link = "report_problems.php?".$groupArr.$hostArr.$timerange;

        //link for report resolved problems page
        $rhistory_link = "report_history.php?".$groupArr.$hostArr.$timerange;
      ?>
                    ...
                    <div class="tab-pane active" id="tab_2-2">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href='report_history.php?&timefrom=<?php echo $timefrom;?>&timetill=<?php echo $timetill;?>'><button class="btn btn-default margin">Reset</button></a>
                            </div>
                        </div>
                    </div><!-- /.tab-pane -->
                    </div><!-- /.tab-content -->
            ...
            <div class="col-md-12">
                <div class="box">
                  <div class="box-tools pull-right">
                    <!--<button class="btn btn-box-tool" onclick="loadReportProblems()" data-toggle="tooltip" title="Refresh"><i class="fa fa-refresh"></i></button>-->
                  </div>
                    <div class="box-body">
                        <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <li><a href='<?php echo $rproblem_link; ?>'>Unresolved Problems</a></li>
                            <li><a href='<?php echo $rhistory_link; ?>'>Resolved Problems (System)</a></li>
                            <li class="active"><a href='<?php echo $closedprob_link; ?>'>Closed Problems (User)</a></li>
                            </ul>
                            <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_3">
                                ...
                                <script>
                                    ...
                                    loadReportClosed();
                                    //var report_problems = setInterval(loadReportProblems, 60000);

                                    //ajax call to load content                                                                      
                                    function loadReportClosed() {
                                        $("#report_closed").load("report/report_closed_data.php?" + groupid + hostid + timerange, function( response, status, xhr ) {
                                          if ( status == "error" ) {
                                            var msg = "Info: ";
                                            $( "#report_closed" ).html( msg + xhr.status + " " + xhr.statusText );
                                          }
                                        });
                                    }

                                    //if click button acknowledge problem, stop interval
                                    function stopIntReportClosed() {
                                        console.log("stop prob int");
                                        clearInterval(report_closed);
                                    }

                                    //if done or close the ack form, start interval back
                                    function startIntReportClosed() {
                                        console.log("start prob int");
                                        //refresh problem table after 1 sec
                                        setTimeout(loadReportClosed, 1000);
                                        report_closed = setInterval(loadReportClosed, 60000);
                                    }
                                </script>
                            </div><!-- /.tab-pane -->
                            </div><!-- /.tab-content -->
