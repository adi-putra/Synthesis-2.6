...
$params = array(
  ...
  "search" => array("name" => "windows", "name" => "ws"),
);
...
<body class="skin-blue">
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                $params = array(
                                                    "output" => array("groupid", "name"),
                                                    "search" => array("name" => array("windows", "ws")),
                                                    "searchByAny" => true
                                                  );
                                                  $result = $zbx->call('hostgroup.get', $params);
                                                  foreach ($result as $row) {
                                                    ...
                                                    if ($row["name"] != $groupname && $row["name"] != "Windows Event Log") {
                                                      $getgroupname = $row["name"];
                                                    } else {
                                                      continue;
                                                    }
                                                  print "<option value='overview_windows1.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="windows-problems" checked><a href="#windows-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="windows-about" checked><a href="#windows-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="windows-uptime" checked><a href="#windows-uptime">Uptime</a></li>
                    ...
                    <li><input type="checkbox" class="sub-box" value="file-read" checked><a href="#file-read">File Read</a></li>
                    <li><input type="checkbox" class="sub-box" value="file-write" checked><a href="#file-write">File Write</a></li>
                    <li><input type="checkbox" class="sub-box" value="forecast-mem" checked><a href="#forecast-mem">Forecast Memory</a></li>
                    <li><input type="checkbox" class="sub-box" value="forecast-disk" checked><a href="#forecast-disk">Forecast Space</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                <div class="box-body">
                  ...
                  <div class="row" id="windows-problems">
                    <div class="col-md-12">
                  ...
                  <div class="row" id="windows-about">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadAbout();
                            if (diff <= 604800 && timetill == "") {
                              var loadabout = setInterval(loadAbout, 60000);
                            }
                            function loadAbout() {      
                              //console.log("load");           
                              $("#loadabout").load("ajax/windows/getabout.php?groupid=" + groupid + hostArr);  
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="windows-uptime">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="getuptime"></div>        
                            <script>
                              loadUptime();
                              if (diff <= 604800 && timetill == "") {
                                var getuptime = setInterval(loadUptime, 60000);
                              }
                              function loadUptime() {      
                                //console.log("load");           
                                $("#getuptime").load("ajax/windows/getuptime.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadCPU();
                            if (diff <= 604800 && timetill == "") {
                              var loadcpu = setInterval(loadCPU, 60000);
                            }
                            function loadCPU() {      
                              //console.log("load");           
                              $("#loadcpu").load("ajax/windows/getcpuload1.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="use-mem">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="loadusedmem"></div>
                          <script>
                            loadMem();
                            if (diff <= 604800 && timetill == "") {
                              var loadusedmem = setInterval(loadMem, 60000);
                            }
                            function loadMem() {      
                              //console.log("load");           
                              $("#loadusedmem").load("ajax/windows/getusedmem.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadCPUGraph();
                            if (diff <= 604800 && timetill == "") {
                              var loadcpuchart = setInterval(loadCPUGraph, 60000);
                            }
                            function loadCPUGraph() {      
                              //console.log("load");           
                              $("#loadcpuchart").load("ajax/windows/getcpugraph.php?" + hostArr + timerange);     
                            }          
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadMemGraph();
                            if (diff <= 604800 && timetill == "") {
                              var loadmemchart = setInterval(loadMemGraph, 60000);
                            }
                            function loadMemGraph() {      
                              //console.log("load");           
                              $("#loadmemchart").load("ajax/windows/getmemgraph.php?" + hostArr + timerange);     
                            }  
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadProcessGraph();
                            if (diff <= 604800 && timetill == "") {
                              var loadprochart = setInterval(loadProcessGraph, 60000);
                            }
                            function loadProcessGraph() {      
                              //console.log("load");           
                              $("#loadprochart").load("ajax/windows/getprocessgraph.php?" + hostArr + timerange);     
                            } 
                          </script>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            loadDisk();
                            if (diff <= 604800 && timetill == "") {
                              var loaddisk = setInterval(loadProcessGraph, 60000);
                            }
                            function loadDisk() {      
                              //console.log("load");           
                              $("#loaddisk").load("ajax/windows/getdisk.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="file-read">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">File Read</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadfileread"></div>
                          <script>
                            loadFileRead();
                            if (diff <= 604800 && timetill == "") {
                              var loadfileread = setInterval(loadFileRead, 60000);
                            }
                            function loadFileRead() {      
                              //console.log("load");           
                              $("#loadfileread").load("ajax/windows/getfileread.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="file-write">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">File Write</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadfilewrite"></div>
                          <script>
                            loadFileWrite();
                            if (diff <= 604800 && timetill == "") {
                              var loadfilewrite = setInterval(loadFileWrite, 60000);
                            }
                            function loadFileWrite() {      
                              //console.log("load");           
                              $("#loadfilewrite").load("ajax/windows/getfilewrite.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="forecast-mem">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          <div id="loadforecastmem"></div>
                          <script>
                            loadForecastMem();
                            if (diff <= 604800 && timetill == "") {
                              var loadforecastmem = setInterval(loadForecastMem, 60000);
                            }
                            function loadForecastMem() {      
                              //console.log("load");           
                              $("#loadforecastmem").load("ajax/windows/get_forecastmem.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="forecast-disk">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Forecast Free Space</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="loadforecastdisk"></div>
                          <script>
                            loadForecastDisk();
                            if (diff <= 604800 && timetill == "") {
                              var loadforecastdisk = setInterval(loadForecastDisk, 60000);
                            }
                            function loadForecastDisk() {      
                              //console.log("load");           
                              $("#loadforecastdisk").load("ajax/windows/get_forecastdisk.php?" + hostArr + timerange);     
                            }
                          </script>
                        </div>
                      </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#problems').DataTable({
        "ajax": 'ajax/windows/getevents.php',
