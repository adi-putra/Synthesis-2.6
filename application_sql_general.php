              ...
              if ($row["name"] != $hostname) {
                ...
                foreach ($row["groups"] as $group) {
                  ...
                  if (stripos($getgroupname, "sql")) {
                    print "<option value='application_sql_general.php?hostid=" . $gethostid . "'>$gethostname</option>";
                  }
                }
              } else {
                continue;
                      ...
                      <div class="box-body">
                        <div class="col-sm-12">
                          <div class="box" style="background-color: #3c8dbc;">
                            ...
                            <div class="box-body">
                              <form action="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                                      <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                          <li><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                          <li><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 hour</a></li>
                                          <li><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 day</a></li>
                                          <li><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 2 days</a></li>
                                          <li><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 7 days</a></li>
                                          <li><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month +2 minutes"); ?>&timetill=<?php echo strtotime("now +2 minutes"); ?>">Last 1 month</a></li>
                                ...
                                <div class="box-body show">
                                  <ul class="nav nav-pills nav-stacked application-nav">
                                    ...
                                    <ul class="nav nav-tabs nav-stacked">
                                      ...
                                      <li class="active"><a href="application_sql_general.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $_GET["timefrom"] ?? strtotime("today"); ?>&timetill=<?php echo $timetill; ?>">General</a></li>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                              ...
                              <div style="padding-bottom: 50px;">
                                ...
                                <div class="box box-solid box-default">
                                  <div class="box-header">
                                    <h3 class="box-title">SQL Server Details</h3>
                                    <div class="box-tools pull-right">
                                      <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                    </div>
                                  </div>
                                  <div class="box-body">
                                    ...
                                    <script>
                                      $("#serverdetails").load("application/sql/system_info/serverdetails.php?hostid=" + hostid);
                                    </script>
                                  </div>
                                </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="inner">
                                            <h3>
                                              ...
                                              <script>
                                                ...
                                                function loadDBTotal() {
                                                  $("#db_total").load("application/sql/system_info/db_info/db_total.php?hostid=" + hostid);
                                                }
                                              </script>
                                            </h3>
                                          </div>
                                      ...
                                      <div class="col-lg-2 col-xs-6 text-center">
                                        <div class="small-box bg-green">
                                          <div class="inner">
                                            <h3>
                                              <div id="db_online"></div>
                                              <script>
                                                loadDBOnlineTotal();

                                                function loadDBOnlineTotal() {
                                                  $("#db_online").load("application/sql/system_info/db_info/db_online.php?hostid=" + hostid);
                                                }
                                              </script>
                                            </h3>
                                          </div>
                                      ...
                                      <div class="col-lg-2 col-xs-6 text-center">
                                        <div class="small-box bg-red">
                                          <div class="inner">
                                            <h3>
                                              <div id="db_offline"></div>
                                              <script>
                                                loadDBOffline();

                                                function loadDBOffline() {
                                                  $("#db_offline").load("application/sql/system_info/db_info/db_offline.php?hostid=" + hostid);
                                                }
                                              </script>
                                            </h3>
                                          </div>
                                      ...
                                      <div class="col-lg-2 col-xs-6 text-center">
                                        <div class="small-box bg-primary" style="background-color: tomato;">
                                          <div class="inner">
                                            <h3>
                                              <div id="db_restoring"></div>
                                              <script>
                                                loadDBRestoring();

                                                function loadDBRestoring() {
                                                  $("#db_restoring").load("application/sql/system_info/db_info/db_restoring.php?hostid=" + hostid);
                                                }
                                              </script>
                                            </h3>
                                          </div>
                                      ...
                                      <div class="col-lg-2 col-xs-6 text-center">
                                        <div class="small-box bg-primary" style="background-color: gray;">
                                          <div class="inner">
                                            <h3>
                                              <div id="db_suspect"></div>
                                              <script>
                                                loadDBSuspect();

                                                function loadDBSuspect() {
                                                  $("#db_suspect").load("application/sql/system_info/db_info/db_suspect.php?hostid=" + hostid);
                                                }
                                              </script>
                                            </h3>
                                          </div>
                                      ...
                                      <div class="col-lg-2 col-xs-6 text-center">
                                        <div class="small-box bg-yellow">
                                          <div class="inner">
                                            <h3>
                                              <div id="db_pending"></div>
                                              <script>
                                                loadDBPending();

                                                function loadDBPending() {
                                                  $("#db_pending").load("application/sql/system_info/db_info/db_pending.php?hostid=" + hostid);
                                                }
                                              </script>
                                            </h3>
                                          </div>
                                ...
                                <div class="box box-solid box-default">
                                  ...
                                  <div class="box-body">
                                    <div id="status"></div>
                                    <script>
                                      $("#status").load("application/sql/system_info/status.php?hostid=" + hostid);
                                    </script>
                                  </div>
                                </div>
                                ...
                                <div class="box box-solid box-default">
                                  <div class="box-header">
                                    <h3 class="box-title">SQL Server Services</h3>
                                    <div class="box-tools pull-right">
                                      <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                    </div>
                                  </div>
                                  <div class="box-body">
                                    <div id="services"></div>
                                    <script>
                                      $("#services").load("application/sql/system_info/services.php?hostid=" + hostid);
                                    </script>
                                  </div>
                                </div>
