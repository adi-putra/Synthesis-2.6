        ...
        <div class="form-group">
          <select class="form-control" name="selecthost" onchange="location = this.value;" style="display: inline-block; width: auto;">
            ...
            foreach ($result as $row) {
              ...
              if (stripos($gethostname, "ilo") !== false or stripos($getgroupname, "ILO") !== false) {
                print "<option value='hostdetails_ilo.php?hostid=" . $gethostid . "'>$gethostname</option>";
              } 
            }
            ?>
          </select>
      ...
      <script>
        ...
        function loadTempGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#temperatures").load("hostdetails/ilo/performance/temperatures.php?hostid=" + hostid + timerange);
          }, 60000);
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadNumPowerSupply() {
                      $("#num_powersupply").load("hostdetails/ilo/cards/num_powersupply.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadNumVDisk() {
                      $("#num_vdisk").load("hostdetails/ilo/cards/num_vdisk.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadNumPhyDisk() {
                      $("#num_pdisk").load("hostdetails/ilo/cards/num_pdisk.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadNumFans() {
                      $("#num_fans").load("hostdetails/ilo/cards/num_fans.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadNumDiskArray() {
                      $("#num_diskarray").load("hostdetails/ilo/cards/num_diskarray.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProblems() {
                      $("#today_problems").load("hostdetails/ilo/cards/today_problems.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
              ...
              <div class="box-body">
                ...
                <div class="col-sm-12">
                  <div class="box" style="background-color: #3c8dbc;">
                    ...
                    <div class="box-body">
                      <form action="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                        <div class="row">
                          <div class="col-lg-4 col-md-4 col-sm-12 text-center" style="padding-bottom: 15px;">
                            <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                              <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                ...
                                <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 hour</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 day</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 2 days</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 7 days</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 month</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-3 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 3 months</a></li>
                                  <li><a href="hostdetails_ilo.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-6 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 6 months</a></li>
                                </ul>
                              </div>
                      ...
                      <div id="systeminfo" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="sysinfo"></div>
                            <script>
                              $("#sysinfo").load("hostdetails/ilo/system_info/systeminfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="status"></div>
                            <script>
                              $("#status").load("hostdetails/ilo/system_info/status.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="general"></div>
                            <script>
                              $("#general").load("hostdetails/ilo/system_info/general.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#sysuptime").load("hostdetails/ilo/system_info/sysuptime.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#power_supply").load("hostdetails/ilo/system_info/power_supply.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Virtual Disks</h3>
                          </div>
                          <div class="box-body">
                            <div id="virtual_disks"></div>
                            <script>
                              $("#virtual_disks").load("hostdetails/ilo/system_info/virtual_disks.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#physical_disks").load("hostdetails/ilo/system_info/physical_disks.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="fans"></div>
                            <script>
                              $("#fans").load("hostdetails/ilo/system_info/fans.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Disk Arrays</h3>
                          </div>
                          <div class="box-body">
                            <div id="disk_arrays"></div>
                            <script>
                              $("#disk_arrays").load("hostdetails/ilo/system_info/disk_arrays.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
