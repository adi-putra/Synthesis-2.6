                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                $params = array(
                                                  ...
                                                  print "<option value='overview_ilo.php?groupid=" . $getgroupid . "'>$getgroupname</option>";
                                                }
                                                ?>
                                              </select>
                                            </div>
        ...
        <div class="row" id="mycontent">
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li class="active"><input type="checkbox" class="sub-box" value="ilo-problems" checked><a href="#ilo-problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-about" checked><a href="#ilo-about">About</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-uptime" checked><a href="#ilo-uptime">Uptime</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-powersupply" checked><a href="#ilo-powersupply">Power Supply</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-virtualdisks" checked><a href="#ilo-virtualdisks">Virtual Disks</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-physicaldisks" checked><a href="#ilo-physicaldisks">Physical Disks</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-fans" checked><a href="#ilo-fans">Fans</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-diskarrays" checked><a href="#ilo-diskarrays">Disk Arrays</a></li>
                    <li><input type="checkbox" class="sub-box" value="ilo-temperatures" checked><a href="#ilo-temperatures">Temperatures</a></li>
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                    ...
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        ...
                        <div class="box-body">
                          ...
                          <script>
                            $("#loadabout").load("ajax/ilo/getabout.php?groupid=" + groupid + "&" + hostArr);
                          </script>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="box-body">
                          <div id="getuptime"></div>        
                            <script>
                              ...
                              function loadUptime() {      
                                //console.log("load");           
                                $("#getuptime").load("ajax/ilo/getuptime.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="ilo-powersupply">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="power_supply"></div>        
                            <script>
                              loadPowerSupply();
                              if (diff <= 604800 && timetill == "") {
                                var power_supply = setInterval(loadPowerSupply, 60000);
                              }
                              function loadPowerSupply() {      
                                //console.log("load");           
                                $("#power_supply").load("ajax/ilo/power_supply.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="ilo-virtualdisks">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="virtual_disks"></div>        
                            <script>
                              loadVirtualDisk();
                              if (diff <= 604800 && timetill == "") {
                                var virtual_disks = setInterval(loadVirtualDisk, 60000);
                              }
                              function loadVirtualDisk() {      
                                //console.log("load");           
                                $("#virtual_disks").load("ajax/ilo/virtual_disks.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="ilo-physicaldisks">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="physical_disks"></div>        
                            <script>
                              loadPhysicalDisk();
                              if (diff <= 604800 && timetill == "") {
                                var physical_disks = setInterval(loadPhysicalDisk, 60000);
                              }
                              function loadPhysicalDisk() {      
                                //console.log("load");           
                                $("#physical_disks").load("ajax/ilo/physical_disks.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                        ...
                        <div class="box-body">
                          <div id="fans"></div>        
                            <script>
                              loadFans();
                              if (diff <= 604800 && timetill == "") {
                                var fans = setInterval(loadFans, 60000);
                              }
                              function loadFans() {      
                                //console.log("load");           
                                $("#fans").load("ajax/ilo/fans.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="ilo-diskarrays">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                          <div id="disk_arrays"></div>        
                            <script>
                              loadDiskArray();
                              if (diff <= 604800 && timetill == "") {
                                var disk_arrays = setInterval(loadDiskArray, 60000);
                              }
                              function loadDiskArray() {      
                                //console.log("load");           
                                $("#disk_arrays").load("ajax/ilo/disk_arrays.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
                  ...
                  <div class="row" id="ilo-temperatures">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Temperatures</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div id="temperatures"></div>        
                            <script>
                              loadTemperatures();
                              if (diff <= 604800 && timetill == "") {
                                var temperatures = setInterval(loadTemperatures, 60000);
                              }
                              function loadTemperatures() {      
                                //console.log("load");           
                                $("#temperatures").load("ajax/ilo/temperatures.php?" + hostArr + timerange);     
                              }
                            </script>
                        </div>
                      </div>
