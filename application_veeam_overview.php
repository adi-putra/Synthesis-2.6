                                              ...
                                              <select class="form-control" onchange="location = this.value;" style="width: auto;">
                                                ...
                                                foreach ($result as $group) {
                                                    if ($group["name"] == $groupid) {
                                                      print "<option value='application_veeam_overview.php?groupid=" . $group["groupid"] . "' selected>" . $group["name"] . "</option>";
                                                    }
                                                    else {
                                                      print "<option value='application_veeam_overview.php?groupid=" . $group["groupid"] . "'>" . $group["name"] . "</option>";
                                                    }
                                                }
                                                ?>
                                              </select>
        ...
        <div class="row">
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body show">
                <ul class="nav nav-pills nav-stacked overview-nav">
                  ...
                  <div class="sub-group">
                    <li><input type="checkbox" class="sub-box" value="veeamoverview_problems" checked><a href="#veeamoverview_problems">Problems</a></li>
                    <li><input type="checkbox" class="sub-box" value="veeamoverview_joboverview" checked><a href="#veeamoverview_joboverview">Job Overview</a></li>
                    <li><input type="checkbox" class="sub-box" value="veeamoverview_calendar" checked><a href="#veeamoverview_calendar">Backup Calendar</a></li>                                    
                  </div>
                </ul>
              </div>
            </div>
          ...
          <div class="content-graph-wrapper">
            <div class="col-lg-10 col-md-9 col-xs-12 wrapper-1 d-block" style="float: right;">
                  ...
                  <div class="row" id="veeamoverview_problems">
                    <div class="col-md-12">
                  ...
                  <div class="row" id="veeamoverview_joboverview">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Jobs Overview</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div class="row">
                            <div class="col-md-12">
                              <div id="jobs_overview"></div>
                              <script>
                                loadJobsOverview();
                                if (diff <= 604800 && timetill == "") {
                                  var jobs_overview = setInterval(loadJobsOverview, 300000);
                                }
                                function loadJobsOverview() {      
                                  //console.log("load");           
                                  $("#jobs_overview").load("application/veeam_overview/jobs/jobs_overview.php?" + hostArr + timerange);     
                                }
                              </script>
                            </div>
                          </div>
                  ...
                  <div class="row" id="veeamoverview_calendar">
                    <div class="col-md-12">
                      <div class="box box-solid box-default">
                        <div class="box-header">
                          <h3 class="box-title">Backup Calendar</h3>
                          <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          </div>
                        </div>
                        <div class="box-body">
                          <div class="row">
                            <div class="col-md-12">
                              <div id="cal_backup"></div>
                              <script>
                                loadCalBackup();
                                if (diff <= 604800 && timetill == "") {
                                  var cal_backup = setInterval(loadCalBackup, 300000);
                                }
                                function loadCalBackup() {      
                                  //console.log("load");           
                                  $("#cal_backup").load("application/veeam_overview/backup/cal_backup.php?" + hostArr + timerange);     
                                }
                              </script>
                            </div>
                          </div>
