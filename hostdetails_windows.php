          ...
          <select class="form-control" name="selecthost" onchange="location = this.value;" style="display: inline-block; width: auto;">
            ...
            foreach ($result as $row) {
              ...
              if (stripos($gethostname, "windows") !== false or stripos($gethostname, "ws") !== false or stripos($getgroupname, "windows") !== false or stripos($getgroupname, "ws") !== false) {
                print "<option value='hostdetails_windows.php?hostid=" . $gethostid . "'>$gethostname</option>";
              }
            }
            ?>
          </select>
...
<script>
        ...
        function loadAllGraph(timefrom, timetill) {
          ...
          loadFileGraph(hostid, timerange);
        ...
        function loadSystemLog(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#window_syslog").load("hostdetails/windows/issues/window_syslog.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadAppLog(hostid, timerange) {
          var interval = setInterval(function() {
            timefrom = '<?php echo $timefrom; ?>';
            //if timetill is same as current time, get new timetill every graph reload
            if (timetill == currTime) {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#window_applog").load("hostdetails/windows/issues/window_applog.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadCPUPercGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#cpu_percentage").load("hostdetails/windows/performance/cpu_percentage.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadNumProGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#num_processes").load("hostdetails/windows/performance/num_processes.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadUsedMemGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#used_memory").load("hostdetails/windows/performance/used_memory.php?hostid=" + hostid + timerange);
            //$("#used_memory_fc").load("hostdetails/windows/performance/used_memory_fc.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadFileGraph(hostid, timerange) {
          var interval = setInterval(function() {
            timefrom = '<?php echo $timefrom; ?>';
            //if timetill is same as current time, get new timetill every graph reload
            if (timetill == currTime) {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#file_readwrite").load("hostdetails/windows/performance/file_readwrite.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadNetTrafficGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#net_traffic").load("hostdetails/windows/performance/net_traffic.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadDiskSpaceGraph(hostid, timerange) {
          var interval = setInterval(function() {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#diskspace").load("hostdetails/windows/capacity/diskspace.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadForecastUsedMem(hostid, timerange) {
          var interval = setInterval(function() {
            timefrom = '<?php echo $timefrom; ?>';
            //if timetill is same as current time, get new timetill every graph reload
            if (timetill == currTime) {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#forecast_memory").load("hostdetails/windows/forecast/forecast_memory.php?hostid=" + hostid + timerange);
          }, 60000);
        ...
        function loadForecastDiskGraph(hostid, timerange) {
          var interval = setInterval(function() {
            timefrom = '<?php echo $timefrom; ?>';
            //if timetill is same as current time, get new timetill every graph reload
            if (timetill == currTime) {
            ...
            timerange = "&timefrom=" + timefrom + "&timetill=" + timetill;
            $("#forecast_disk").load("hostdetails/windows/forecast/forecast_disk.php?hostid=" + hostid + timerange);
          }, 60000);
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentCPU() {
                      $("#current_cpu").load("hostdetails/windows/cards/current_cpu.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentMem() {
                      $("#current_memory").load("hostdetails/windows/cards/current_memory.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProc() {
                      $("#current_processes").load("hostdetails/windows/cards/current_processes.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
                ...
                <h3>
                  ...
                  <script>
                    ...
                    function loadCurrentProblems() {
                      $("#today_problems").load("hostdetails/windows/cards/today_problems.php?hostid=" + hostid);
                    }
                  </script>
                </h3>
                <p>
              ...
              <div class="box-body">
                ...
                <div class="col-sm-12">
                  <div class="box" style="background-color: #3c8dbc;">
                    ...
                    <div class="box-body">
                      <form action="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo $timefrom; ?>&timetill=<?php echo $timetill; ?>" method="post">
                        <div class="row">
                            ...
                            <div class="input-group" style="padding-right: 15px;padding-left: 15px;">
                              <div class="input-group-addon" style="background:none;border:none;padding:0;">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>">Today</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 hour"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 hour</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 day"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 day</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-2 days"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 2 days</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 week"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 7 days</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-1 month"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 1 month</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-3 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 3 months</a></li>
                                  <li><a href="hostdetails_windows.php?hostid=<?php echo $hostid; ?>&timefrom=<?php echo strtotime("-6 months"); ?>&timetill=<?php echo strtotime("now"); ?>">Last 6 months</a></li>
                                </ul>
                              </div>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-lg-10 col-md-9 col-sm-12" id="content-wrapper-host">
                      ...
                      <div id="systeminfo" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="sysinfo"></div>
                            <script>
                              $("#sysinfo").load("hostdetails/windows/system_info/systeminfo.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="status"></div>
                            <script>
                              $("#status").load("hostdetails/windows/system_info/status.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#cpuMemDisk").load("hostdetails/windows/system_info/cpumemdisk.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            ...
                            <script>
                              $("#sysuptime").load("hostdetails/windows/system_info/sysuptime.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class="box-body">
                            <div id="services"></div>
                            <script>
                              $("#services").load("hostdetails/windows/system_info/stateofservices.php?hostid=" + hostid);
                            </script>
                          </div>
                        </div>
                      ...
                      <div id="performance" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">Number of Processes Graph</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                        ...
                        <div class="box box-solid box-default">
                          <div class="box-header">
                            <h3 class="box-title">File Read/Write Graph</h3>
                            <div class="box-tools pull-right">
                              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                          <div class='box-body'>
                            <div id='file_readwrite'></div>
                            <script>
                              loadFileGraph(hostid, timerange);
                            </script>
                          </div>
                      ...
                      <div id="capacity" style="padding-bottom: 50px;">
                        ...
                        <div class="box box-solid box-default" style="height: auto;">
                          ...
                          <div class='box-body'>
                            ...
                            <script>
                              $("#diskspace_pie").load("hostdetails/windows/capacity/diskspace_pie.php?hostid=" + hostid + "&timefrom=" + timefrom + "&timetill=" + timetill);
                            </script>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="box box-solid box-default">
                          ...
                          <div class='box-body'>
                            ...
                            <script>
                              loadForecastUsedMem(hostid, timerange);
                            </script>
                          </div>
                        </div>
                        ...
                        <div class="box box-solid box-default">
                          ...
                          <div class='box-body'>
                            ...
                            <script>
                              loadForecastDiskGraph(hostid, timerange);
                            </script>
                          </div>
                        </div>
                      </div>
